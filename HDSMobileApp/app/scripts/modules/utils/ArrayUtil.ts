...
class ArrayUtil {
     ...
     */
    static addAll<E>(src: E[], toAdd: E[]): E[] {
     ...
     */
    static arrayUnique(ary: any[]): any[] {
     ...
     */
    static arrayUniqueCountAsObject(ary: any[]): { [id: string]: number } {
        if (ary == null || ary.length < 1) { return ary == null ? null : {}; }
        ary = ary.sort();
        var res: { [id: string]: number } = {};
        res[ary[0]] = 1;
        for (var i = 1, size = ary.length; i < size; i++) {
     ...
     * where {@code aryVal} is a value from the original {@code ary} and {@code count} is the number of times it occured
     */
    static arrayUniqueCountAsKeyValueArray<T>(ary: T[]): { key: string; value: number }[] {
        var res: { [id: string]: number } = ArrayUtil.arrayUniqueCountAsObject(ary);
        var results: { key: string; value: number }[] = [];
     ...
     */
    static arrayUnion<T>(ary1: T[], ary2: T[]): T[] {
     ...
     */
    static withAllProp<T>(ary: T[], propName?: string, propValue?: any, propName2?: string, propValue2?: any,
            propName3?: string, propValue3?: any): T[] {
        if (ary != null) {
            if (propName != null) {
                if (propName2 != null) {
                    if (propName3 != null) {
     ...
     * @return {Array} an array of objects from the input array that contain a matching property
     */
    static withAnyProp<T>(ary: T[], propName?: string, propValue?: any, propName2?: string, propValue2?: any,
            propName3?: string, propValue3?: any): T[] {
        if (ary != null) {
            if (propName != null) {
                if (propName2 != null) {
     ...
     */
    static with1Prop<T>(ary: T[] | ArrayLike<T>, propName: string, propValue: any): T[] {
        if (ary == null || propName == null || propValue === undefined) { return []; }
        var results: T[] = [];
     ...
     * @see with1Prop()
     */
    static withAll2Prop<T>(ary: T[] | ArrayLike<T>, propName: string, propValue: any, propName2: string, propValue2: any): T[] {
        if (ary == null || propName == null || propName2 == null || propValue === undefined || propValue2 === undefined) { return []; }
        var results: T[] = [];
        var obj = null;
        for (var i = 0, size = ary.length; i < size; i++) {
            obj = ary[i];
     ...
     * @see with1Prop()
     */
    static withAny2Prop<T>(ary: T[] | ArrayLike<T>, propName: string, propValue: any, propName2: string, propValue2: any): T[] {
        if (ary == null || propName == null || propName2 == null || propValue === undefined || propValue2 === undefined) { return []; }
        var results: T[] = [];
        var obj = null;
        for (var i = 0, size = ary.length; i < size; i++) {
     ...
     * @see with1Prop()
     */
    static withAll3Prop<T>(ary: T[] | ArrayLike<T>, propName: string, propValue: any, propName2: string, propValue2: any,
            propName3: string, propValue3: any): T[] {
        if (ary == null || propName == null || propName2 == null || propName3 == null ||
            propValue === undefined || propValue2 === undefined || propValue3 === undefined) { return []; }
        var results: T[] = [];
        var obj = null;
        for (var i = 0, size = ary.length; i < size; i++) {
            obj = ary[i];
     ...
     * @see with1Prop()
     */
    static withAny3Prop<T>(ary: T[] | ArrayLike<T>, propName: string, propValue: any, propName2: string, propValue2: any,
            propName3: string, propValue3: any): T[] {
        if (ary == null || propName == null || propName2 == null || propName3 == null ||
            propValue === undefined || propValue2 === undefined || propValue3 === undefined) { return []; }
        var results: T[] = [];
     ...
     */
    static without1Prop<T>(ary: T[] | ArrayLike<T>, propName: string, propValue: any): T[] {
        if (ary == null || propName == null || propValue === undefined) { return []; }
        var results: T[] = [];
        for (var i = 0, size = ary.length; i < size; i++) {
            var obj = ary[i];
     ...
     */
    static indexOfPropValue<T>(ary: T[] | ArrayLike<T>, propName: string, propValue: any): number {
     ...
     * @return {Integer} the array index of an object with a matching property, -1 if no matching object was found
     */
    static lastIndexOfPropValue<T>(ary: T[] | ArrayLike<T>, propName: string, propValue: any): number {
        if (ary == null || propName == null || propValue === undefined) { return -1; }
     ...
     */
    static findPropValue<T>(ary: T[] | ArrayLike<T>, propName: string, propValue: any): T {
     ...
     */
    static findOne<T>(ary: T[] | ArrayLike<T>, filter: (val: T) => boolean, propName?: string, ensureOne: boolean = false): any {
     ...
     * object if {@code propName} is not null, or null if a result cannot be found
     */
    static findOneByProp<T>(ary: T[] | ArrayLike<T>, searchPropName: string, searchPropValue: any, resultPropName?: string, ensureOne: boolean = false): any {
     ...
     */
    static setAllProp(ary: any[] | ArrayLike<any>, propName: string, propValue: any): void {
     ...
     */
    static getAllProp(ary: any[] | ArrayLike<any>, propName: string): any[] {
        if (ary == null || propName == null) { return []; }
     ...
     */
    static hasItems<T>(ary: T[] | ArrayLike<T>) {
     ...
     */
    static containsAll<T>(ary: T[], searchFor: T[]): boolean {
     ...
     */
    static clearArray(ary: any[]): void {
        if (ary == null) { return; }
        for (var i = 0, size = ary.length; i < size; i++) {
            ary.pop();
        }
     ...
     */
    static arraySum(ary: any[] | ArrayLike<any>): number {
     ...
     */
    static arrayFastRemoveValue<T>(ary: T[], value: any): T[] {
     ...
     */
    static arrayFastRemoveIndex<T>(ary: T[], index: number): T[] {
        if (ary == null || ary.length === 0) { return ary; }
     ...
     */
    static arrayRemoveIndex<T>(ary: T[], index: number): T[] {
     ...
     * This function differs from {@link ArrayUtil#isAllSameInstance()} by
     * requiring {@code expectedConstructorName} to be non-null
     *
     * @param {Array} ary: the array of objects to check. Return false if null.
     * @param {String|Function(Object):Boolean} expectedConstructorName: the expected
     * name of all of the {@code ary} elements' constructors. Or a function that takes
     * an element of the array and returns a boolean indicate if the element matches the
     * expected type (true) or not (false). Error if null.
     * @return {Boolean} true if all of the elements in the array match
     * @see isAllSameInstance
     */
    static isAllInstance(ary: any[], expectedConstructorName: (any) => boolean): boolean;
    static isAllInstance(ary: any[], expectedConstructorName: string): boolean;
    static isAllInstance(ary: any[], expectedConstructorName: any): boolean {
     ...
     */
    static isAllSameInstance(ary: any[], expectedConstructorName: string | ((any) => boolean)): boolean {
     ...
     * @return {Boolean} true if all of the elements in the array match
     */
    static isAllInstanceOf(ary: any[], parentClass: any): boolean {
     ...
     */
    static isStringArray(ary: any[]): boolean {
        if (!Array.isArray(ary) || ary == null) {
     ...
     */
    static isNumberArray(ary: any[]): boolean {
        if (!Array.isArray(ary) || ary == null) {
            throw new Error("incorrect usage (" + ary + "), " + "expected (Array ary)");
        }
        for (var i = ary.length - 1; i > -1; i--) {
     ...
     */
    static arrayLooseEqual<T>(ary1: T[], ary2: T[]): boolean {
     ...
     * @see arrayDifference()
     */
    static arrayLooseDifference<T>(ary1: T[], ary2: T[]): T[] {
     ...
     */
    static arrayDifference<T>(ary1: T[], ary2: T[]): { added: T[]; removed: T[] } {
        if (ary1 == null || ary2 == null || !Array.isArray(ary1) || !Array.isArray(ary2)) {
     ...
     * @see arrayLooseDifference()
     */
    static arrayKeyValueDifference<K, V>(aryKeys1: K[], aryKeys2: K[], aryValues1: V[], aryValues2: V[]):
            { added: V[]; removed: V[] } {
     ...
     */
    static toPercentagesOfTotal(ary: any[], total?: number): number[] {
        if (ary == null) { return []; }
        if (total != null && typeof total !== "number") { throw new Error("incorrect parameter 'total': '" + total + "' must be a number if not null"); }
        ...
        for (var i = aryLen - 1; i > -1; i--) {
            ...
            if (val < 0) { throw new Error("negative value '" + ary[i] + "' at index " + i + ", cannot calculate percentage value of negative array values"); }
            sum += val;
        }
     ...
     */
    static spliceArray<T>(origAry: T[], insertAry: T[], index: number, deleteCount: number = 0) {
    ...
    // Aliases
    static diff = ArrayUtil.arrayDifference;
    static looseDiff = ArrayUtil.arrayLooseDifference;
    static fastRemoveValue = ArrayUtil.arrayFastRemoveValue;
    static fastRemoveIndex = ArrayUtil.arrayFastRemoveIndex;
    static removeIndex = ArrayUtil.arrayRemoveIndex;
    static union = ArrayUtil.arrayUnion;
    static unique = ArrayUtil.arrayUnique;
