...
var LocalStoreByDate = (function() {
  ...
  LocalStoreByDate.removeOldItems = function(localStore, removePercentage, minItemsRemoved, maxItemsRemoved) {
    if (minItemsRemoved === void 0) {
      minItemsRemoved = 1;
    }
    var timestamps = [];
    var itemKeys = localStore.getKeys();
    for (var i = 0,
        size = itemKeys.length; i < size; i++) {
  ...
  LocalStoreByDate.test = function() {
    ...
    var str = new Array(10001).join("0,");
    var newKeys = [];
    var tmp = 0;
    var tmpLoops = 0;
    var loops = 3;
...
var Ps = (function() {
  ...
  Ps.resetAppNewPage = function(psInst, svcs, wnd, pageDocument, url) {
    if (pageDocument === void 0) {
      pageDocument = wnd.document;
    }
    if (url === void 0) {
...
var PsLog = (function() {
  ...
  PsLog.getBrowserConsoleAppender = function() {
    if (PsLog._browserConsoleAppender == null) {
      ...
      log.setLayout(new log4javascript.SimpleLayout());
...
var LocalStoreAppender = (function() {
  function LocalStoreAppender(localStore, mergeGroupEvents) {
    if (mergeGroupEvents === void 0) {
      mergeGroupEvents = false;
    }
...
var Services = (function() {
  ...
  Services.callGetService = function(relativeUrl, parameterNames, parameterValues, expectArrayResponse, responseDataPropertyName, requestProperties) {
    ...
    if (parameterNames != null && parameterValues != null) {
      ...
      for (var paramI = 0,
          size = parameterNames.length; paramI < size; paramI++) {
...
var ObjectUtil = (function() {
  ...
  ObjectUtil.hasMatchingProperties = function(obj, propNames, template_condition, requiredCount) {
    "use strict";
    if (requiredCount === void 0) {
      requiredCount = (propNames != null ? propNames.length : 0);
    }
    if (obj == null) {
      return false;
    }
    ...
    var nonNullCount = 0;
    for (var i = 0,
        size = propNames.length; i < size; i++) {
  ...
  ObjectUtil.extend = function(classChild, classParent, allowChildToOverride) {
    "use strict";
    if (allowChildToOverride === void 0) {
      allowChildToOverride = true;
    }
    ...
    for (var key in childProto) {
      if (childProto.hasOwnProperty(key)) {
        if (allowChildToOverride && newChildProto.hasOwnProperty(key)) {} else {
          newChildProto[key] = childProto[key];
        }
      }
    }
    Object.defineProperty(classChild.prototype, "constructor", {value: classChild});
  };
  ObjectUtil.extendToStatic = function(classChild, classParent, allowChildToOverride, throwErrorIfOverwrites) {
    ...
    if (throwErrorIfOverwrites === void 0) {
      throwErrorIfOverwrites = true;
    }
  ...
  ObjectUtil.runTest = function(testFunctions) {
    ...
    for (var i = 0,
        size = testFunctions.length; i < size; i++) {
