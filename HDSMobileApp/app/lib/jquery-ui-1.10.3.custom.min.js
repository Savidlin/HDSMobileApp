...
(function (e, t) {
	...
	e.widget = function (i, a, s) {
		...
		e.each(s, function (i, s) {
			return e.isFunction(s) ? (l[i] = function () {
				...
				t = function (e) {
					return a.prototype[i].apply(this, e)
				};
				return function () {
					var i,
					a = this._super,
		...
		r ? (e.each(r._childConstructors, function (t, i) {
			...
			}), delete r._childConstructors) : a._childConstructors.push(o),
		e.widget.bridge(i, o)
	},
	e.widget.extend = function (i) {
		for (var s, n, r = a.call(arguments, 1), o = 0, h = r.length; h > o; o++)
			for (s in r[o])
				n = r[o][s], r[o].hasOwnProperty(s) && n !== t && (i[s] = e.isPlainObject(n) ? e.isPlainObject(i[s]) ? e.widget.extend({}, i[s], n) : e.widget.extend({}, n) : n);
		return i
	},
	...
	e.Widget.prototype = {
		...
		_createWidget : function (t, a) {
			e(a || this.defaultElement || this)[0];
			this.element = e(a);
			this.uuid = i++;
			...
			this.focusable = e();
			if(a !== this) {
				e.data(a, this.widgetFullName, this);
				this._on(!0, this.element, {
					remove : function (e) {
						e.target === a && this.destroy()
					}
				});
				this.document = e(a.style ? a.ownerDocument : a.document || a);
		...
		option : function (i, a) {
			...
			if ("string" == typeof i)
				if (o = {}, s = i.split("."), i = s.shift(), s.length) {
					for (n = o[i] = e.widget.extend({}, this.options[i]), r = 0; s.length - 1 > r; r++)
						n[s[r]] = n[s[r]] || {},
					n = n[s[r]];
					if (i = s.pop(), a === t)
		...
		_on : function (i, a, s) {
			var n,
			r = this;
			"boolean" != typeof i && (s = a, a = i, i = !1),
			s ? (a = n = e(a), this.bindings = this.bindings.add(a)) : (s = a, a = this.element, n = this.widget()),
		...
		_trigger : function (t, i, a) {
			...
			!(e.isFunction(r) && r.apply(this.element[0], [i].concat(a)) === !1 || i.isDefaultPrevented())
		}
	},
	e.each({
		show : "fadeIn",
		...
		e.Widget.prototype["_" + t] = function (a, s, n) {
			...
			var r,
			o = s ? s === !0 || "number" == typeof s ? i : s.effect || i : t;
			s = s || {},
			"number" == typeof s && (s = {
					duration : s
				}),
			...
			r && e.effects && e.effects.effect[o] ? a[t](s) : o !== t && a[o] ? a[o](s.duration, s.easing, n) : a.queue(function (i) {
				e(this)[t](),
				n && n.call(a[0]),
				i()
			})
	...
	e.widget("ui.mouse", {
		...
		_mouseDown : function (a) {
			if (!t) {
				...
				var i = this,
				r = 1 === a.which,
				s = "string" == typeof this.options.cancel && a.target.nodeName ? e(a.target).closest(this.options.cancel).length : !1;
				return r && !s && this._mouseCapture(a) ? (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout(function () {
								i.mouseDelayMet = !0
...
(function (e, t) {
	...
	e.position = {
		scrollbarWidth : function () {
			...
			var a,
			i,
			r = e("<div style='display:block;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"),
			n = r.children()[0];
			return e("body").append(r),
			a = n.offsetWidth,
			r.css("overflow", "scroll"),
			i = n.offsetWidth,
			a === i && (i = r[0].clientWidth),
			r.remove(),
			s = a - i
		},
		getScrollInfo : function (t) {
			var a = t.isWindow ? "" : t.element.css("overflow-x"),
			i = t.isWindow ? "" : t.element.css("overflow-y"),
			r = "scroll" === a || "auto" === a && t.width < t.element[0].scrollWidth,
		...
		getWithinInfo : function (t) {
			...
			return {
				...
				width : i ? a.width() : a.outerWidth(),
				height : i ? a.height() : a.outerHeight()
			}
		}
	},
	e.fn.position = function (t) {
		...
		v,
		x = e(t.of),
		k = e.position.getWithinInfo(t.within),
		b = e.position.getScrollInfo(k),
		T = (t.collision || "flip").split(" "),
		S = {};
		return v = r(x),
		x[0].preventDefault && (t.at = "left top"),
		m = v.width,
		f = v.height,
		g = v.offset,
		y = e.extend({}, g),
		e.each(["my", "at"], function () {
			...
			a,
			i = (t[this] || "").split(" ");
			1 === i.length && (i = d.test(i[0]) ? i.concat(["center"]) : l.test(i[0]) ? ["center"].concat(i) : ["center", "center"]),
			i[0] = d.test(i[0]) ? i[0] : "center",
			i[1] = l.test(i[1]) ? i[1] : "center",
			e = h.exec(i[0]),
			a = h.exec(i[1]),
			S[this] = [e ? e[0] : 0, a ? a[0] : 0],
			t[this] = [c.exec(i[0])[0], c.exec(i[1])[0]]
		}),
		1 === T.length && (T[1] = T[0]),
		"right" === t.at[0] ? y.left += m : "center" === t.at[0] && (y.left += m / 2),
		"bottom" === t.at[1] ? y.top += f : "center" === t.at[1] && (y.top += f / 2),
		s = a(S.at, m, f),
		y.left += s[0],
		y.top += s[1],
		this.each(function () {
			...
			p = i(this, "marginLeft"),
			v = i(this, "marginTop"),
			M = h + p + i(this, "marginRight") + b.width,
			N = c + v + i(this, "marginBottom") + b.height,
			D = e.extend({}, y),
			_ = a(S.my, l.outerWidth(), l.outerHeight());
			"right" === t.my[0] ? D.left -= h : "center" === t.my[0] && (D.left -= h / 2),
			"bottom" === t.my[1] ? D.top -= c : "center" === t.my[1] && (D.top -= c / 2),
			D.left += _[0],
			D.top += _[1],
			e.support.offsetFractions || (D.left = u(D.left), D.top = u(D.top)),
			r = {
				marginLeft : p,
				marginTop : v
			},
			e.each(["left", "top"], function (a, i) {
				e.ui.position[T[a]] && e.ui.position[T[a]][i](D, {
					targetWidth : m,
					targetHeight : f,
					elemWidth : h,
					elemHeight : c,
			...
			t.using && (d = function (e) {
				...
				u = {
					...
					horizontal : 0 > i ? "left" : a > 0 ? "right" : "center",
					vertical : 0 > s ? "top" : r > 0 ? "bottom" : "middle"
				};
				h > m && m > o(a + i) && (u.horizontal = "center"),
				c > f && f > o(r + s) && (u.vertical = "middle"),
				u.important = n(o(a), o(i)) > n(o(r), o(s)) ? "horizontal" : "vertical",
	...
	e.ui.position = {
		fit : {
			left : function (e, t) {
				...
				u = r - o,
				d = o + t.collisionWidth - s - r;
				t.collisionWidth > s ? u > 0 && 0 >= d ? (a = e.left + u + t.collisionWidth - s - r, e.left += u - a) : e.left = d > 0 && 0 >= u ? r : u > d ? r + s - t.collisionWidth : r : u > 0 ? e.left += u : d > 0 ? e.left -= d : e.left = n(e.left - o, e.left)
			},
			top : function (e, t) {
				var a,
				i = t.within,
				...
				u = r - o,
				d = o + t.collisionHeight - s - r;
				t.collisionHeight > s ? u > 0 && 0 >= d ? (a = e.top + u + t.collisionHeight - s - r, e.top += u - a) : e.top = d > 0 && 0 >= u ? r : u > d ? r + s - t.collisionHeight : r : u > 0 ? e.top += u : d > 0 ? e.top -= d : e.top = n(e.top - o, e.top)
			}
		},
		flip : {
			left : function (e, t) {
				...
				l = d - u,
				h = d + t.collisionWidth - n - u,
				c = "left" === t.my[0] ? -t.elemWidth : "right" === t.my[0] ? t.elemWidth : 0,
				m = "left" === t.at[0] ? t.targetWidth : "right" === t.at[0] ? -t.targetWidth : 0,
				p = -2 * t.offset[0];
				0 > l ? (a = e.left + c + m + p + t.collisionWidth - n - s, (0 > a || o(l) > a) && (e.left += c + m + p)) : h > 0 && (i = e.left - t.collisionPosition.marginLeft + c + m + p - u, (i > 0 || h > o(i)) && (e.left += c + m + p))
			},
			top : function (e, t) {
				var a,
				i,
				...
				l = d - u,
				h = d + t.collisionHeight - n - u,
				c = "top" === t.my[1],
				m = c ? -t.elemHeight : "bottom" === t.my[1] ? t.elemHeight : 0,
				p = "top" === t.at[1] ? t.targetHeight : "bottom" === t.at[1] ? -t.targetHeight : 0,
				f = -2 * t.offset[1];
				0 > l ? (i = e.top + m + p + f + t.collisionHeight - n - s, e.top + m + p + f > l && (0 > i || o(l) > i) && (e.top += m + p + f)) : h > 0 && (a = e.top - t.collisionPosition.marginTop + m + p + f - u, e.top + m + p + f > h && (a > 0 || h > o(a)) && (e.top += m + p + f))
			}
		},
		flipfit : {
			left : function () {
...
(function (e) {
	e.widget("ui.draggable", e.ui.mouse, {
		...
		_mouseStart : function (t) {
			...
			this._trigger("start", t) === !1 ? (this._clear(), !1) : (this._cacheHelperProportions(), e.ui.ddmanager && !a.dropBehaviour && e.ui.ddmanager.prepareOffsets(this, t), this._mouseDrag(t, !0), e.ui.ddmanager && e.ui.ddmanager.dragStart(this, t), !0)
		},
		...
		_createHelper : function (t) {
			...
			return i.parents("body").length || i.appendTo("parent" === a.appendTo ? this.element[0].parentNode : a.appendTo),
	...
	e.ui.plugin.add("draggable", "connectToSortable", {
		start : function (t, a) {
			...
			e(r.connectToSortable).each(function () {
				...
				a && !a.options.disabled && (i.sortables.push({
					...
					}), a.refreshPositions(), a._trigger("activate", t, s))
			})
		},
		stop : function (t, a) {
			var i = e(this).data("ui-draggable"),
		...
		drag : function (t, a) {
			...
			e.each(i.sortables, function () {
				...
				this.instance._intersectsWith(this.instance.containerCache) && (s = !0, e.each(i.sortables, function () {
						return this.instance.positionAbs = i.positionAbs,
						this.instance.helperProportions = i.helperProportions,
						this.instance.offset.click = i.offset.click,
						this !== n && this.instance._intersectsWith(this.instance.containerCache) && e.contains(n.instance.element[0], this.instance.element[0]) && (s = !1),
						s
					})),
	...
	e.ui.plugin.add("draggable", "cursor", {
		start : function () {
			...
			t.css("cursor") && (a._cursor = t.css("cursor")),
			t.css("cursor", a.cursor)
		},
		stop : function () {
	...
	e.ui.plugin.add("draggable", "scroll", {
		...
		drag : function (t) {
			...
			i = a.options,
			r = !1;
			a.scrollParent[0] !== document && "HTML" !== a.scrollParent[0].tagName ? (i.axis && "x" === i.axis || (a.overflowOffset.top + a.scrollParent[0].offsetHeight - t.pageY < i.scrollSensitivity ? a.scrollParent[0].scrollTop = r = a.scrollParent[0].scrollTop + i.scrollSpeed : t.pageY - a.overflowOffset.top < i.scrollSensitivity && (a.scrollParent[0].scrollTop = r = a.scrollParent[0].scrollTop - i.scrollSpeed)), i.axis && "y" === i.axis || (a.overflowOffset.left + a.scrollParent[0].offsetWidth - t.pageX < i.scrollSensitivity ? a.scrollParent[0].scrollLeft = r = a.scrollParent[0].scrollLeft + i.scrollSpeed : t.pageX - a.overflowOffset.left < i.scrollSensitivity && (a.scrollParent[0].scrollLeft = r = a.scrollParent[0].scrollLeft - i.scrollSpeed))) : (i.axis && "x" === i.axis || (t.pageY - e(document).scrollTop() < i.scrollSensitivity ? r = e(document).scrollTop(e(document).scrollTop() - i.scrollSpeed) : e(window).height() - (t.pageY - e(document).scrollTop()) < i.scrollSensitivity && (r = e(document).scrollTop(e(document).scrollTop() + i.scrollSpeed))), i.axis && "y" === i.axis || (t.pageX - e(document).scrollLeft() < i.scrollSensitivity ? r = e(document).scrollLeft(e(document).scrollLeft() - i.scrollSpeed) : e(window).width() - (t.pageX - e(document).scrollLeft()) < i.scrollSensitivity && (r = e(document).scrollLeft(e(document).scrollLeft() + i.scrollSpeed)))),
			r !== !1 && e.ui.ddmanager && !i.dropBehaviour && e.ui.ddmanager.prepareOffsets(a, t)
		}
	}),
	e.ui.plugin.add("draggable", "snap", {
		...
		drag : function (t, a) {
			...
			h,
			c,
			m = e(this).data("ui-draggable"),
			p = m.options,
			f = p.snapTolerance,
			g = a.offset.left,
			y = g + m.helperProportions.width,
			k = a.offset.top,
			x = k + m.helperProportions.height;
			for (h = m.snapElements.length - 1; h >= 0; h--)
				o = m.snapElements[h].left, d = o + m.snapElements[h].width, u = m.snapElements[h].top, l = u + m.snapElements[h].height, o - f > y || g > d + f || u - f > x || k > l + f || !e.contains(m.snapElements[h].item.ownerDocument, m.snapElements[h].item) ? (m.snapElements[h].snapping && m.options.snap.release && m.options.snap.release.call(m.element, t, e.extend(m._uiHash(), {
							snapItem : m.snapElements[h].item
						})), m.snapElements[h].snapping = !1) : ("inner" !== p.snapMode && (i = f >= Math.abs(u - x), r = f >= Math.abs(l - k), s = f >= Math.abs(o - y), n = f >= Math.abs(d - g), i && (a.position.top = m._convertPositionTo("relative", {
									top : u - m.helperProportions.height,
									left : 0
								}).top - m.margins.top), r && (a.position.top = m._convertPositionTo("relative", {
									top : l,
									left : 0
								}).top - m.margins.top), s && (a.position.left = m._convertPositionTo("relative", {
									top : 0,
									left : o - m.helperProportions.width
								}).left - m.margins.left), n && (a.position.left = m._convertPositionTo("relative", {
									top : 0,
									left : d
								}).left - m.margins.left)), c = i || r || s || n, "outer" !== p.snapMode && (i = f >= Math.abs(u - k), r = f >= Math.abs(l - x), s = f >= Math.abs(o - g), n = f >= Math.abs(d - y), i && (a.position.top = m._convertPositionTo("relative", {
									top : u,
									left : 0
								}).top - m.margins.top), r && (a.position.top = m._convertPositionTo("relative", {
								...
								}).left - m.margins.left)), !m.snapElements[h].snapping && (i || r || s || n || c) && m.options.snap.snap && m.options.snap.snap.call(m.element, t, e.extend(m._uiHash(), {
							snapItem : m.snapElements[h].item
						})), m.snapElements[h].snapping = i || r || s || n || c)
		}
	}),
...
(function (e) {
	...
	e.widget("ui.droppable", {
		...
		_create : function () {
			...
			this.isover = !1,
			this.isout = !0,
			this.accept = e.isFunction(a) ? a : function (e) {
				return e.is(a)
			},
			this.proportions = {
		...
		_destroy : function () {
			for (var t = 0, a = e.ui.ddmanager.droppables[this.options.scope]; a.length > t; t++)
				a[t] === this && a.splice(t, 1);
			this.element.removeClass("ui-droppable ui-droppable-disabled")
		},
		_setOption : function (t, a) {
			"accept" === t && (this.accept = e.isFunction(a) ? a : function (e) {
				return e.is(a)
			}),
			e.Widget.prototype._setOption.apply(this, arguments)
		},
		_activate : function (t) {
			var a = e.ui.ddmanager.current;
			this.options.activeClass && this.element.addClass(this.options.activeClass),
			a && this._trigger("activate", t, this.ui(a))
		},
		_deactivate : function (t) {
			var a = e.ui.ddmanager.current;
			this.options.activeClass && this.element.removeClass(this.options.activeClass),
			a && this._trigger("deactivate", t, this.ui(a))
		},
		_over : function (t) {
			var a = e.ui.ddmanager.current;
			a && (a.currentItem || a.element)[0] !== this.element[0] && this.accept.call(this.element[0], a.currentItem || a.element) && (this.options.hoverClass && this.element.addClass(this.options.hoverClass), this._trigger("over", t, this.ui(a)))
		},
		_out : function (t) {
			var a = e.ui.ddmanager.current;
			a && (a.currentItem || a.element)[0] !== this.element[0] && this.accept.call(this.element[0], a.currentItem || a.element) && (this.options.hoverClass && this.element.removeClass(this.options.hoverClass), this._trigger("out", t, this.ui(a)))
		},
		_drop : function (t, a) {
			var i = a || e.ui.ddmanager.current,
			r = !1;
			return i && (i.currentItem || i.element)[0] !== this.element[0] ? (this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function () {
					...
					return t.options.greedy && !t.options.disabled && t.options.scope === i.options.scope && t.accept.call(t.element[0], i.currentItem || i.element) && e.ui.intersect(i, e.extend(t, {
						...
						}), t.options.tolerance) ? (r = !0, !1) : undefined
	...
	e.ui.intersect = function (e, a, i) {
		...
		d = (e.positionAbs || e.position.absolute).top,
		u = d + e.helperProportions.height,
		l = a.offset.left,
		h = l + a.proportions.width,
		c = a.offset.top,
		m = c + a.proportions.height;
		switch (i) {
		case "fit":
			return n >= l && h >= o && d >= c && m >= u;
		case "intersect":
			return n + e.helperProportions.width / 2 > l && h > o - e.helperProportions.width / 2 && d + e.helperProportions.height / 2 > c && m > u - e.helperProportions.height / 2;
		case "pointer":
			...
			t(s, c, a.proportions.height) && t(r, l, a.proportions.width);
		case "touch":
			return (d >= c && m >= d || u >= c && m >= u || c > d && u > m) && (n >= l && h >= n || o >= l && h >= o || l > n && o > h);
		default:
			return !1
		}
	},
	e.ui.ddmanager = {
		...
		prepareOffsets : function (t, a) {
			...
			e : for (i = 0; s.length > i; i++)
				if (!(s[i].options.disabled || t && !s[i].accept.call(s[i].element[0], t.currentItem || t.element))) {
					...
					s[i].visible && ("mousedown" === n && s[i]._activate.call(s[i], a), s[i].offset = s[i].element.offset(), s[i].proportions = {
		...
		drop : function (t, a) {
			...
			return e.each((e.ui.ddmanager.droppables[t.options.scope] || []).slice(), function () {
				this.options && (!this.options.disabled && this.visible && e.ui.intersect(t, this, this.options.tolerance) && (i = this._drop.call(this, a) || i), !this.options.disabled && this.visible && this.accept.call(this.element[0], t.currentItem || t.element) && (this.isout = !0, this.isover = !1, this._deactivate.call(this, a)))
			}),
			i
		},
		dragStart : function (t, a) {
			t.element.parentsUntil("body").bind("scroll.droppable", function () {
				t.options.refreshPositions || e.ui.ddmanager.prepareOffsets(t, a)
			})
		},
		drag : function (t, a) {
			t.options.refreshPositions && e.ui.ddmanager.prepareOffsets(t, a),
			e.each(e.ui.ddmanager.droppables[t.options.scope] || [], function () {
				if (!this.options.disabled && !this.greedyChild && this.visible) {
					...
					r,
					s,
					n = e.ui.intersect(t, this, this.options.tolerance),
					...
					o && (this.options.greedy && (r = this.options.scope, s = this.element.parents(":data(ui-droppable)").filter(function () {
								...
								}), s.length && (i = e.data(s[0], "ui-droppable"), i.greedyChild = "isover" === o)), i && "isover" === o && (i.isover = !1, i.isout = !0, i._out.call(i, a)), this[o] = !0, this["isout" === o ? "isover" : "isout"] = !1, this["isover" === o ? "_over" : "_out"].call(this, a), i && "isout" === o && (i.isout = !1, i.isover = !0, i._over.call(i, a)))
				}
			})
		},
		dragStop : function (t, a) {
...
(function (e) {
	...
	e.widget("ui.resizable", e.ui.mouse, {
		...
		_create : function () {
			...
			if (this.element.addClass("ui-resizable"), e.extend(this, {
				...
				for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), t = this.handles.split(","), this.handles = {}, i = 0; t.length > i; i++)
					a = e.trim(t[i]), s = "ui-resizable-" + a, r = e("<div class='ui-resizable-handle " + s + "'></div>"), r.css({
						zIndex : o.zIndex
		...
		_mouseCapture : function (t) {
			...
			r = !1;
			for (i in this.handles)
				a = e(this.handles[i])[0], (a === t.target || e.contains(a, t.target)) && (r = !0);
		...
		_mouseStart : function (i) {
			...
			/absolute/.test(d.css("position")) ? d.css({
				position : "absolute",
				top : d.css("top"),
				left : d.css("left")
			...
			this._renderProxy(),
			a = t(this.helper.css("left")),
			r = t(this.helper.css("top")),
			n.containment && (a += e(n.containment).scrollLeft() || 0, r += e(n.containment).scrollTop() || 0),
		...
		_mouseStop : function (t) {
			...
			h = this.options,
			u = this;
			return this._helper && (i = this._proportionallyResizeElements, a = i.length && /textarea/i.test(i[0].nodeName), r = a && e.ui.hasScroll(i[0], "left") ? 0 : u.sizeDiff.height, s = a ? 0 : u.sizeDiff.width, n = {
					width : u.helper.width() - s,
					height : u.helper.height() - r
				}, o = parseInt(u.element.css("left"), 10) + (u.position.left - u.originalPosition.left) || null, d = parseInt(u.element.css("top"), 10) + (u.position.top - u.originalPosition.top) || null, h.animate || this.element.css(e.extend(n, {
						top : d,
						left : o
		...
		_updateVirtualBoundaries : function (e) {
			...
			(this._aspectRatio || e) && (t = n.minHeight * this.aspectRatio, r = n.minWidth / this.aspectRatio, a = n.maxHeight * this.aspectRatio, s = n.maxWidth / this.aspectRatio, t > n.minWidth && (n.minWidth = t), r > n.minHeight && (n.minHeight = r), n.maxWidth > a && (n.maxWidth = a), n.maxHeight > s && (n.maxHeight = s)),
			this._vBoundaries = n
		},
		...
		_updateRatio : function (e) {
			...
			"sw" === r && (e.left = t.left + (a.width - e.width), e.top = null),
			"nw" === r && (e.top = t.top + (a.height - e.height), e.left = t.left + (a.width - e.width)),
			e
		},
		_respectSize : function (e) {
			...
			r && (e.width = t.maxWidth),
			s && (e.height = t.maxHeight),
			n && u && (e.left = d - t.minWidth),
			r && u && (e.left = d - t.maxWidth),
			o && l && (e.top = h - t.minHeight),
			s && l && (e.top = h - t.maxHeight),
			...
			if (this._proportionallyResizeElements.length) {
				...
				for (e = 0; this._proportionallyResizeElements.length > e; e++) {
					if (r = this._proportionallyResizeElements[e], !this.borderDif)
						for (this.borderDif = [], i = [r.css("borderTopWidth"), r.css("borderRightWidth"), r.css("borderBottomWidth"), r.css("borderLeftWidth")], a = [r.css("paddingTop"), r.css("paddingRight"), r.css("paddingBottom"), r.css("paddingLeft")], t = 0; i.length > t; t++)
							this.borderDif[t] = (parseInt(i[t], 10) || 0) + (parseInt(a[t], 10) || 0);
					r.css({
	...
	e.ui.plugin.add("resizable", "animate", {
		stop : function (t) {
			...
			i.element.animate(e.extend(d, u && h ? {
					top : u,
					left : h
				}
					 : {}), {
	...
	e.ui.plugin.add("resizable", "containment", {
		start : function () {
			...
			o,
			d,
			h = e(this).data("ui-resizable"),
			u = h.options,
			l = h.element,
			c = u.containment,
			m = c instanceof e ? c.get(0) : /parent/.test(c) ? l.parent().get(0) : c;
			m && (h.containerElement = e(m), /document/.test(c) || c === document ? (h.containerOffset = {
						left : 0,
						top : 0
					}, h.containerPosition = {
						left : 0,
					...
					}, r = h.containerOffset, s = h.containerSize.height, n = h.containerSize.width, o = e.ui.hasScroll(m, "left") ? m.scrollWidth : n, d = e.ui.hasScroll(m) ? m.scrollHeight : s, h.parentData = {
						element : m,
						left : r.left,
						top : r.top,
						width : o,
		...
		resize : function (t) {
			...
			c[0] !== document && /static/.test(c.css("position")) && (l = d),
			h.left < (n._helper ? d.left : 0) && (n.size.width = n.size.width + (n._helper ? n.position.left - d.left : n.position.left - l.left), u && (n.size.height = n.size.width / n.aspectRatio), n.position.left = o.helper ? d.left : 0),
			h.top < (n._helper ? d.top : 0) && (n.size.height = n.size.height + (n._helper ? n.position.top - d.top : n.position.top), u && (n.size.width = n.size.height * n.aspectRatio), n.position.top = n._helper ? d.top : 0),
			n.offset.left = n.parentData.left + n.position.left,
			n.offset.top = n.parentData.top + n.position.top,
			i = Math.abs((n._helper ? n.offset.left - l.left : n.offset.left - l.left) + n.sizeDiff.width),
			a = Math.abs((n._helper ? n.offset.top - l.top : n.offset.top - d.top) + n.sizeDiff.height),
			r = n.containerElement.get(0) === n.element.parent().get(0),
			s = /relative|absolute/.test(n.containerElement.css("position")),
			r && s && (i -= n.parentData.left),
			i + n.size.width >= n.parentData.width && (n.size.width = n.parentData.width - i, u && (n.size.height = n.size.width / n.aspectRatio)),
			a + n.size.height >= n.parentData.height && (n.size.height = n.parentData.height - a, u && (n.size.width = n.size.height * n.aspectRatio))
		},
		stop : function () {
	...
	e.ui.plugin.add("resizable", "grid", {
		resize : function () {
			...
			d = o[0] || 1,
			h = o[1] || 1,
			u = Math.round((a.width - r.width) / d) * d,
			l = Math.round((a.height - r.height) / h) * h,
			c = r.width + u,
			m = r.height + l,
			...
			p && (c -= d),
			f && (m -= h),
			/^(se|s|e)$/.test(n) ? (t.size.width = c, t.size.height = m) : /^(ne)$/.test(n) ? (t.size.width = c, t.size.height = m, t.position.top = s.top - l) : /^(sw)$/.test(n) ? (t.size.width = c, t.size.height = m, t.position.left = s.left - u) : (t.size.width = c, t.size.height = m, t.position.top = s.top - l, t.position.left = s.left - u)
		}
	})
})(jQuery);
(function (e) {
	e.widget("ui.selectable", e.ui.mouse, {
		...
		_mouseStart : function (t) {
			...
			this.options.disabled || (this.selectees = e(a.filter, this.element[0]), this._trigger("start", t), e(a.appendTo).append(this.helper), this.helper.css({
					left : t.pageX,
					top : t.pageY,
					width : 0,
					height : 0
					...
					a.startselected = !0,
					t.metaKey || t.ctrlKey || (a.$element.removeClass("ui-selected"), a.selected = !1, a.$element.addClass("ui-unselecting"), a.unselecting = !0, i._trigger("unselecting", t, {
							unselecting : a.element
						}))
				}), e(t.target).parents().addBack().each(function () {
					var a,
					r = e.data(this, "selectable-item");
					return r ? (a = !t.metaKey && !t.ctrlKey || !r.$element.hasClass("ui-selected"), r.$element.removeClass(a ? "ui-unselecting" : "ui-selected").addClass(a ? "ui-selecting" : "ui-unselecting"), r.unselecting = !a, r.selecting = a, r.selected = a, a ? i._trigger("selecting", t, {
							selecting : r.element
		...
		_mouseDrag : function (t) {
			if (this.dragged = !0, !this.options.disabled) {
				...
				this.selectees.each(function () {
					...
					d = !1;
					i && i.element !== a.element[0] && ("touch" === r.tolerance ? d = !(i.left > o || s > i.right || i.top > l || n > i.bottom) : "fit" === r.tolerance && (d = i.left > s && o > i.right && i.top > n && l > i.bottom), d ? (i.selected && (i.$element.removeClass("ui-selected"), i.selected = !1), i.unselecting && (i.$element.removeClass("ui-unselecting"), i.unselecting = !1), i.selecting || (i.$element.addClass("ui-selecting"), i.selecting = !0, a._trigger("selecting", t, {
									selecting : i.element
								}))) : (i.selecting && ((t.metaKey || t.ctrlKey) && i.startselected ? (i.$element.removeClass("ui-selecting"), i.selecting = !1, i.$element.addClass("ui-selected"), i.selected = !0) : (i.$element.removeClass("ui-selecting"), i.selecting = !1, i.startselected && (i.$element.addClass("ui-unselecting"), i.unselecting = !0), a._trigger("unselecting", t, {
										unselecting : i.element
									}))), i.selected && (t.metaKey || t.ctrlKey || i.startselected || (i.$element.removeClass("ui-selected"), i.selected = !1, i.$element.addClass("ui-unselecting"), i.unselecting = !0, a._trigger("unselecting", t, {
										unselecting : i.element
									})))))
				}),
				!1
	...
	e.widget("ui.sortable", e.ui.mouse, {
		...
		_mouseCapture : function (t, i) {
			...
			return this.reverting ? !1 : this.options.disabled || "static" === this.options.type ? !1 : (this._refreshItems(t), e(t.target).parents().each(function () {
					return e.data(this, r.widgetName + "-item") === r ? (a = e(this), !1) : undefined
				}), e.data(t.target, r.widgetName + "-item") === r && (a = e(t.target)), a ? !this.options.handle || i || (e(this.options.handle, a).find("*").addBack().each(function () {
						this === t.target && (s = !0)
					}), s) ? (this.currentItem = a, this._removeCurrentsFromItems(), !0) : !1 : !1)
		},
		...
		_mouseDrag : function (t) {
			...
			n = this.options,
			o = !1;
			for (this.position = this._generatePosition(t), this.positionAbs = this._convertPositionTo("absolute"), this.lastPositionAbs || (this.lastPositionAbs = this.positionAbs), this.options.scroll && (this.scrollParent[0] !== document && "HTML" !== this.scrollParent[0].tagName ? (this.overflowOffset.top + this.scrollParent[0].offsetHeight - t.pageY < n.scrollSensitivity ? this.scrollParent[0].scrollTop = o = this.scrollParent[0].scrollTop + n.scrollSpeed : t.pageY - this.overflowOffset.top < n.scrollSensitivity && (this.scrollParent[0].scrollTop = o = this.scrollParent[0].scrollTop - n.scrollSpeed), this.overflowOffset.left + this.scrollParent[0].offsetWidth - t.pageX < n.scrollSensitivity ? this.scrollParent[0].scrollLeft = o = this.scrollParent[0].scrollLeft + n.scrollSpeed : t.pageX - this.overflowOffset.left < n.scrollSensitivity && (this.scrollParent[0].scrollLeft = o = this.scrollParent[0].scrollLeft - n.scrollSpeed)) : (t.pageY - e(document).scrollTop() < n.scrollSensitivity ? o = e(document).scrollTop(e(document).scrollTop() - n.scrollSpeed) : e(window).height() - (t.pageY - e(document).scrollTop()) < n.scrollSensitivity && (o = e(document).scrollTop(e(document).scrollTop() + n.scrollSpeed)), t.pageX - e(document).scrollLeft() < n.scrollSensitivity ? o = e(document).scrollLeft(e(document).scrollLeft() - n.scrollSpeed) : e(window).width() - (t.pageX - e(document).scrollLeft()) < n.scrollSensitivity && (o = e(document).scrollLeft(e(document).scrollLeft() + n.scrollSpeed))), o !== !1 && e.ui.ddmanager && !n.dropBehaviour && e.ui.ddmanager.prepareOffsets(this, t)), this.positionAbs = this._convertPositionTo("absolute"), this.options.axis && "y" === this.options.axis || (this.helper[0].style.left = this.position.left + "px"), this.options.axis && "x" === this.options.axis || (this.helper[0].style.top = this.position.top + "px"), i = this.items.length - 1; i >= 0; i--)
				if (a = this.items[i], s = a.item[0], r = this._intersectsWithPointer(a), r && a.instance === this.currentContainer && s !== this.currentItem[0] && this.placeholder[1 === r ? "next" : "prev"]()[0] !== s && !e.contains(this.placeholder[0], s) && ("semi-dynamic" === this.options.type ? !e.contains(this.element[0], s) : !0)) {
					if (this.direction = 1 === r ? "down" : "up", "pointer" !== this.options.tolerance && !this._intersectsWithSides(a))
						break;
					this._rearrange(t, a),
		...
		_mouseStop : function (t, i) {
			if (t) {
				if (e.ui.ddmanager && !this.options.dropBehaviour && e.ui.ddmanager.drop(this, t), this.options.revert) {
					...
					r = this.options.axis,
					n = {};
					r && "x" !== r || (n.left = s.left - this.offset.parent.left - this.margins.left + (this.offsetParent[0] === document.body ? 0 : this.offsetParent[0].scrollLeft)),
					r && "y" !== r || (n.top = s.top - this.offset.parent.top - this.margins.top + (this.offsetParent[0] === document.body ? 0 : this.offsetParent[0].scrollTop)),
					this.reverting = !0,
					e(this.helper).animate(n, parseInt(this.options.revert, 10) || 500, function () {
						a._clear(t)
					})
				} else
					this._clear(t, i);
		...
		_intersectsWith : function (e) {
			...
			d = "x" === this.options.axis || a + l > o && h > a + l,
			c = "y" === this.options.axis || t + u > r && n > t + u,
			m = d && c;
			return "pointer" === this.options.tolerance || this.options.forcePointerForContainers || "pointer" !== this.options.tolerance && this.helperProportions[this.floating ? "width" : "height"] > e[this.floating ? "width" : "height"] ? m : t + this.helperProportions.width / 2 > r && n > i - this.helperProportions.width / 2 && a + this.helperProportions.height / 2 > o && h > s - this.helperProportions.height / 2
		},
		_intersectsWithPointer : function (e) {
			var i = "x" === this.options.axis || t(this.positionAbs.top + this.offset.click.top, e.top, e.height),
			a = "y" === this.options.axis || t(this.positionAbs.left + this.offset.click.left, e.left, e.width),
			s = i && a,
			r = this._getDragVerticalDirection(),
			n = this._getDragHorizontalDirection();
			return s ? this.floating ? n && "right" === n || "down" === r ? 2 : 1 : r && ("down" === r ? 2 : 1) : !1
		},
		_intersectsWithSides : function (e) {
			var i = t(this.positionAbs.top + this.offset.click.top, e.top + e.height / 2, e.height),
			a = t(this.positionAbs.left + this.offset.click.left, e.left + e.width / 2, e.width),
			s = this._getDragVerticalDirection(),
			r = this._getDragHorizontalDirection();
			return this.floating && r ? "right" === r && a || "left" === r && !a : s && ("down" === s && i || "up" === s && !i)
		},
		...
		_getItemsAsjQuery : function (t) {
			...
			if (h && t)
				for (i = h.length - 1; i >= 0; i--)
					for (s = e(h[i]), a = s.length - 1; a >= 0; a--)
						r = e.data(s[a], this.widgetFullName), r && r !== this && !r.options.disabled && o.push([e.isFunction(r.options.items) ? r.options.items.call(r.element) : e(r.options.items, r.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), r]);
		...
		_refreshItems : function (t) {
			...
			if (c && this.ready)
				for (i = c.length - 1; i >= 0; i--)
					for (s = e(c[i]), a = s.length - 1; a >= 0; a--)
						r = e.data(s[a], this.widgetFullName), r && r !== this && !r.options.disabled && (d.push([e.isFunction(r.options.items) ? r.options.items.call(r.element[0], t, {
										item : this.currentItem
									}) : e(r.options.items, r.element), r]), this.containers.push(r));
			for (i = d.length - 1; i >= 0; i--)
				for (n = d[i][1], o = d[i][0], a = 0, l = o.length; l > a; a++)
					h = e(o[a]), h.data(this.widgetName + "-item", n), u.push({
						item : h,
						instance : n,
						width : 0,
						height : 0,
		...
		refreshPositions : function (t) {
			...
			for (i = this.items.length - 1; i >= 0; i--)
				a = this.items[i], a.instance !== this.currentContainer && this.currentContainer && a.item[0] !== this.currentItem[0] || (s = this.options.toleranceElement ? e(this.options.toleranceElement, a.item) : a.item, t || (a.width = s.outerWidth(), a.height = s.outerHeight()), r = s.offset(), a.left = r.left, a.top = r.top);
		...
		_createPlaceholder : function (t) {
			...
			var i,
			a = t.options;
			a.placeholder && a.placeholder.constructor !== String || (i = a.placeholder, a.placeholder = {
					element : function () {
						var a = t.currentItem[0].nodeName.toLowerCase(),
						s = e("<" + a + ">", t.document[0]).addClass(i || t.currentItem[0].className + " ui-sortable-placeholder").removeClass("ui-sortable-helper");
						return "tr" === a ? t.currentItem.children().each(function () {
							e("<td>&#160;</td>", t.document[0]).attr("colspan", e(this).attr("colspan") || 1).appendTo(s)
						}) : "img" === a && s.attr("src", t.currentItem.attr("src")),
						i || s.css("visibility", "hidden"),
						s
					},
					update : function (e, s) {
						(!i || a.forcePlaceholderSize) && (s.height() || s.height(t.currentItem.innerHeight() - parseInt(t.currentItem.css("paddingTop") || 0, 10) - parseInt(t.currentItem.css("paddingBottom") || 0, 10)), s.width() || s.width(t.currentItem.innerWidth() - parseInt(t.currentItem.css("paddingLeft") || 0, 10) - parseInt(t.currentItem.css("paddingRight") || 0, 10)))
					}
				}),
			t.placeholder = e(a.placeholder.element.call(t.element, t.currentItem)),
			t.currentItem.after(t.placeholder),
			a.placeholder.update(t, t.placeholder)
		},
			...
			for (s = this.containers.length - 1; s >= 0; s--)
				if (!e.contains(this.currentItem[0], this.containers[s].element[0]))
					if (this._intersectsWith(this.containers[s].containerCache)) {
						if (p && e.contains(this.containers[s].element[0], p.element[0]))
							continue;
						p = this.containers[s],
						f = s
					} else
						this.containers[s].containerCache.over && (this.containers[s]._trigger("out", a, this._uiHash(this)), this.containers[s].containerCache.over = 0);
			if (p)
				if (1 === this.containers.length)
					this.containers[f].containerCache.over || (this.containers[f]._trigger("over", a, this._uiHash(this)), this.containers[f].containerCache.over = 1);
				else {
					for (n = 1e4, o = null, m = p.floating || i(this.currentItem), h = m ? "left" : "top", l = m ? "width" : "height", u = this.positionAbs[h] + this.offset.click[h], r = this.items.length - 1; r >= 0; r--)
						e.contains(this.containers[f].element[0], this.items[r].item[0]) && this.items[r].item[0] !== this.currentItem[0] && (!m || t(this.positionAbs.top + this.offset.click.top, this.items[r].top, this.items[r].height)) && (d = this.items[r].item.offset()[h], c = !1, Math.abs(d - u) > Math.abs(d + this.items[r][l] - u) && (c = !0, d += this.items[r][l]), n > Math.abs(d - u) && (n = Math.abs(d - u), o = this.items[r], this.direction = c ? "up" : "down"));
					if (!o && !this.options.dropOnEmpty)
						return;
					if (this.currentContainer === this.containers[f])
						return;
					o ? this._rearrange(a, o, null, !0) : this._rearrange(a, null, this.containers[f].element, !0),
		...
		_createHelper : function (t) {
			...
			return a.parents("body").length || e("parent" !== i.appendTo ? i.appendTo : this.currentItem[0].parentNode)[0].appendChild(a[0]),
			...
			(!a[0].style.width || i.forceHelperSize) && a.width(this.currentItem.width()),
			(!a[0].style.height || i.forceHelperSize) && a.height(this.currentItem.height()),
			a
		},
		_adjustOffsetFromHelper : function (t) {
			"string" == typeof t && (t = t.split(" ")),
		...
		_convertPositionTo : function (t, i) {
			...
			return {
				top : i.top + this.offset.relative.top * a + this.offset.parent.top * a - ("fixed" === this.cssPosition ? -this.scrollParent.scrollTop() : r ? 0 : s.scrollTop()) * a,
				left : i.left + this.offset.relative.left * a + this.offset.parent.left * a - ("fixed" === this.cssPosition ? -this.scrollParent.scrollLeft() : r ? 0 : s.scrollLeft()) * a
			}
		},
		_generatePosition : function (t) {
			var i,
			...
			this.originalPosition && (this.containment && (t.pageX - this.offset.click.left < this.containment[0] && (r = this.containment[0] + this.offset.click.left), t.pageY - this.offset.click.top < this.containment[1] && (n = this.containment[1] + this.offset.click.top), t.pageX - this.offset.click.left > this.containment[2] && (r = this.containment[2] + this.offset.click.left), t.pageY - this.offset.click.top > this.containment[3] && (n = this.containment[3] + this.offset.click.top)), s.grid && (i = this.originalPageY + Math.round((n - this.originalPageY) / s.grid[1]) * s.grid[1], n = this.containment ? i - this.offset.click.top >= this.containment[1] && i - this.offset.click.top <= this.containment[3] ? i : i - this.offset.click.top >= this.containment[1] ? i - s.grid[1] : i + s.grid[1] : i, a = this.originalPageX + Math.round((r - this.originalPageX) / s.grid[0]) * s.grid[0], r = this.containment ? a - this.offset.click.left >= this.containment[0] && a - this.offset.click.left <= this.containment[2] ? a : a - this.offset.click.left >= this.containment[0] ? a - s.grid[0] : a + s.grid[0] : a)), {
				top : n - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + ("fixed" === this.cssPosition ? -this.scrollParent.scrollTop() : h ? 0 : o.scrollTop()),
				left : r - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + ("fixed" === this.cssPosition ? -this.scrollParent.scrollLeft() : h ? 0 : o.scrollLeft())
			}
		},
		...
		_clear : function (e, t) {
			...
			for (this.fromOutside && !t && a.push(function (e) {
				...
				t || a.push(function (e) {
					...
					.call(this, this.containers[i])), this.containers[i].containerCache.over && (a.push(function (e) {
						return function (t) {
			...
			if (this.storedCursor && (this.document.find("body").css("cursor", this.storedCursor), this.storedStylesheet.remove()), this._storedOpacity && this.helper.css("opacity", this._storedOpacity), this._storedZIndex && this.helper.css("zIndex", "auto" === this._storedZIndex ? "" : this._storedZIndex), this.dragging = !1, this.cancelHelperRemoval) {
				if (!t) {
					for (this._trigger("beforeStop", e, this._uiHash()), i = 0; a.length > i; i++)
						a[i].call(this, e);
...
(function (e) {
	...
	a = {},
	r = {};
	a.height = a.paddingTop = a.paddingBottom = a.borderTopWidth = a.borderBottomWidth = "hide",
	...
	e.widget("ui.accordion", {
		...
		_keydown : function (t) {
			if (!t.altKey && !t.ctrlKey) {
				...
				case a.RIGHT:
				case a.DOWN:
					n = this.headers[(i + 1) % r];
					break;
				case a.LEFT:
				case a.UP:
					n = this.headers[(i - 1 + r) % r];
					break;
				case a.SPACE:
				case a.ENTER:
		...
		_refresh : function () {
			...
			this.headers.attr("role", "tab").each(function (t) {
				...
				i = a.next(),
				n = i.attr("id");
				r || (r = s + "-header-" + t, a.attr("id", r)),
				n || (n = s + "-panel-" + t, i.attr("id", n)),
				a.attr("aria-controls", n),
			...
			"fill" === i ? (a = n.height(), this.element.siblings(":visible").each(function () {
					var t = e(this),
					r = t.css("position");
					"absolute" !== r && "fixed" !== r && (a -= t.outerHeight(!0))
				}), this.headers.each(function () {
					a -= e(this).outerHeight(!0)
				}), this.headers.next().each(function () {
					e(this).height(Math.max(0, a - e(this).innerHeight() + e(this).height()))
				}).css("overflow", "auto")) : "auto" === i && (a = 0, this.headers.next().each(function () {
					a = Math.max(a, e(this).css("height", "").height())
				}).height(a))
		},
		_activate : function (t) {
			var a = this._findActive(t)[0];
		...
		_toggle : function (t) {
			...
			this.prevShow = a,
			this.prevHide = r,
			this.options.animate ? this._animate(a, r, t) : (r.hide(), a.show(), this._toggleComplete(t)),
			r.attr({
				"aria-expanded" : "false",
				"aria-hidden" : "true"
			}),
			r.prev().attr("aria-selected", "false"),
			a.length && r.length ? r.prev().attr("tabIndex", -1) : a.length && this.headers.filter(function () {
		...
		_animate : function (e, t, i) {
			...
			d = this,
			u = 0,
			m = e.length && (!t.length || e.index() < t.index()),
			...
			o = o || h.duration || c.duration,
			t.length ? e.length ? (n = e.show().outerHeight(), t.animate(a, {
					duration : o,
					easing : s,
					step : function (e, t) {
						t.now = Math.round(e)
					...
					step : function (e, a) {
						a.now = Math.round(e),
						"height" !== a.prop ? u += a.now : "content" !== d.options.heightStyle && (a.now = Math.round(n - t.outerHeight() - u), u = 0)
					}
				}), undefined) : t.animate(a, o, s, l) : e.animate(r, o, s, l)
		},
...
(function (e) {
	...
	e.widget("ui.autocomplete", {
		...
		_create : function () {
			...
			n = "textarea" === i,
			s = "input" === i;
			this.isMultiLine = n ? !0 : s ? !1 : this.element.prop("isContentEditable"),
			...
			this._on(this.element, {
				...
				keypress : function (r) {
					if (t)
						return t = !1, (!this.isMultiLine || this.menu.element.is(":visible")) && r.preventDefault(), undefined;
					if (!a) {
						var i = e.ui.keyCode;
						switch (r.keyCode) {
						case i.PAGE_UP:
			...
			this._on(this.menu.element, {
				mousedown : function (t) {
					...
					e(t.target).closest(".ui-menu-item").length || this._delay(function () {
						...
						this.document.one("mousedown", function (r) {
							r.target === t.element[0] || r.target === a || e.contains(a, r.target) || t.close()
						})
					})
				},
				menufocus : function (t, a) {
					...
					var r = a.item.data("ui-autocomplete-item");
					!1 !== this._trigger("focus", t, {
						item : r
					}) ? t.originalEvent && /^key/.test(t.originalEvent.type) && this._value(r.value) : this.liveRegion.text(r.value)
				},
				menuselect : function (e, t) {
					var a = t.item.data("ui-autocomplete-item"),
					r = this.previous;
		...
		_initSource : function () {
			...
			a,
			r = this;
			e.isArray(this.options.source) ? (t = this.options.source, this.source = function (a, r) {
				r(e.ui.autocomplete.filter(t, a.term))
			}) : "string" == typeof this.options.source ? (a = this.options.source, this.source = function (t, i) {
				r.xhr && r.xhr.abort(),
				r.xhr = e.ajax({
						url : a,
						data : t,
		...
		_renderItem : function (t, a) {
			return e("<li>").append(e("<a>").text(a.label)).appendTo(t)
		},
		_move : function (e, t) {
	...
	e.extend(e.ui.autocomplete, {
		...
		filter : function (t, a) {
			var r = RegExp(e.ui.autocomplete.escapeRegex(a), "i");
...
(function (e) {
	...
	r,
	i,
	n = "ui-button ui-widget ui-state-default ui-corner-all",
	...
	e.widget("ui.button", {
		...
		_create : function () {
			...
			var s = this,
			o = this.options,
			m = "checkbox" === this.type || "radio" === this.type,
			c = m ? "" : "ui-state-active",
			h = "ui-state-focus";
			...
			m && (this.element.bind("change" + this.eventNamespace, function () {
					i || s.refresh()
		...
		_determineButtonType : function () {
			...
			"checkbox" === this.type || "radio" === this.type ? (e = this.element.parents().last(), t = "label[for='" + this.element.attr("id") + "']", this.buttonElement = e.find(t), this.buttonElement.length || (e = e.length ? e.siblings() : this.element.siblings(), this.buttonElement = e.filter(t), this.buttonElement.length || (this.buttonElement = e.find(t))), this.element.addClass("ui-helper-hidden-accessible"), a = this.element.is(":checked"), a && this.buttonElement.addClass("ui-state-active"), this.buttonElement.prop("aria-pressed", a)) : this.buttonElement = this.element
		},
		widget : function () {
		...
		_destroy : function () {
			...
			this.buttonElement.removeClass(n + " " + s + " " + o).removeAttr("role").removeAttr("aria-pressed").html(this.buttonElement.find(".ui-button-text").html()),
		...
		_resetButton : function () {
			...
			n = [];
			r.primary || r.secondary ? (this.options.text && n.push("ui-button-text-icon" + (i ? "s" : r.primary ? "-primary" : "-secondary")), r.primary && t.prepend("<span class='ui-button-icon-primary ui-icon " + r.primary + "'></span>"), r.secondary && t.append("<span class='ui-button-icon-secondary ui-icon " + r.secondary + "'></span>"), this.options.text || (n.push(i ? "ui-button-icons-only" : "ui-button-icon-only"), this.hasTitle || t.attr("title", e.trim(a)))) : n.push("ui-button-text-only"),
			t.addClass(n.join(" "))
		}
	}),
...
(function (e, t) {
	...
	e.extend(a.prototype, {
		...
		_connectDatepicker : function (t, a) {
			...
			a.append = e([]),
			a.trigger = e([]),
			i.hasClass(this.markerClassName) || (this._attachments(i, a), i.addClass(this.markerClassName).keydown(this._doKeyDown).keypress(this._doKeyPress).keyup(this._doKeyUp), this._autoSize(a), e.data(t, r, a), a.settings.disabled && this._disableDatepicker(t))
		},
		_attachments : function (t, a) {
			...
			r && (a.append = e("<span class='" + this._appendClass + "'>" + r + "</span>"), t[o ? "before" : "after"](a.append)),
			t.unbind("focus", this._showDatepicker),
			a.trigger && a.trigger.remove(),
			i = this._get(a, "showOn"),
			("focus" === i || "both" === i) && t.focus(this._showDatepicker),
			("button" === i || "both" === i) && (s = this._get(a, "buttonText"), n = this._get(a, "buttonImage"), a.trigger = e(this._get(a, "buttonImageOnly") ? e("<img/>").addClass(this._triggerClass).attr({
							src : n,
							alt : s,
							title : s
		...
		_dialogDatepicker : function (t, a, i, n, o) {
			...
			h,
			p = this._dialogInst;
			return p || (this.uuid += 1, c = "dp" + this.uuid, this._dialogInput = e("<input type='text' id='" + c + "' style='position: absolute; top: -100px; width: 0px;'/>"), this._dialogInput.keydown(this._doKeyDown), e("body").append(this._dialogInput), p = this._dialogInst = this._newInst(this._dialogInput, !1), p.settings = {}, e.data(this._dialogInput[0], r, p)),
			s(p.settings, n || {}),
			a = a && a.constructor === Date ? this._formatDate(p, a) : a,
			this._dialogInput.val(a),
			this._pos = o ? o.length ? o : [o.pageX, o.pageY] : null,
			this._pos || (d = document.documentElement.clientWidth, l = document.documentElement.clientHeight, u = document.documentElement.scrollLeft || document.body.scrollLeft, h = document.documentElement.scrollTop || document.body.scrollTop, this._pos = [d / 2 - 100 + u, l / 2 - 150 + h]),
		...
		_doKeyDown : function (t) {
			...
			if (n._keyEvent = !0, e.datepicker._datepickerShowing)
				...
				case 13:
					...
					a = e.datepicker._get(n, "onSelect"),
					a ? (i = e.datepicker._formatDate(n), a.apply(n.input ? n.input[0] : null, [i, n])) : e.datepicker._hideDatepicker(),
					!1;
				case 27:
					e.datepicker._hideDatepicker();
					break;
		...
		_doKeyPress : function (a) {
			var i,
			s,
			n = e.datepicker._getInst(a.target);
		...
		_showDatepicker : function (t) {
			if (t = t.target || t, "input" !== t.nodeName.toLowerCase() && (t = e("input", t.parentNode)[0]), !e.datepicker._isDisabledDatepicker(t) && e.datepicker._lastInput !== t) {
				...
				e.datepicker._curInst && e.datepicker._curInst !== a && (e.datepicker._curInst.dpDiv.stop(!0, !0), a && e.datepicker._datepickerShowing && e.datepicker._hideDatepicker(e.datepicker._curInst.input[0])),
				i = e.datepicker._get(a, "beforeShow"),
				n = i ? i.apply(t, [t, a]) : {},
				n !== !1 && (s(a.settings, n), a.lastVal = null, e.datepicker._lastInput = t, e.datepicker._setDateFromField(a), e.datepicker._inDialog && (t.value = ""), e.datepicker._pos || (e.datepicker._pos = e.datepicker._findPos(t), e.datepicker._pos[1] += t.offsetHeight), r = !1, e(t).parents().each(function () {
		...
		_checkOffset : function (t, a, i) {
			...
			return a.left -= this._get(t, "isRTL") ? s - r : 0,
			a.left -= i && a.left === t.input.offset().left ? e(document).scrollLeft() : 0,
			a.top -= i && a.top === t.input.offset().top + o ? e(document).scrollTop() : 0,
			a.left -= Math.min(a.left, a.left + s > c && c > s ? Math.abs(a.left + s - c) : 0),
			a.top -= Math.min(a.top, a.top + n > d && d > n ? Math.abs(n + o) : 0),
			a
		},
		_findPos : function (t) {
		...
		_gotoToday : function (t) {
			...
			i = e(t),
			s = this._getInst(i[0]);
			this._get(s, "gotoCurrent") && s.currentDay ? (s.selectedDay = s.currentDay, s.drawMonth = s.selectedMonth = s.currentMonth, s.drawYear = s.selectedYear = s.currentYear) : (a = new Date, s.selectedDay = a.getDate(), s.drawMonth = s.selectedMonth = a.getMonth(), s.drawYear = s.selectedYear = a.getFullYear()),
		...
		_selectMonthYear : function (t, a, i) {
			var s = e(t),
			n = this._getInst(s[0]);
			n["selected" + ("M" === i ? "Month" : "Year")] = n["draw" + ("M" === i ? "Month" : "Year")] = parseInt(a.options[a.selectedIndex].value, 10),
		...
		_selectDate : function (t, a) {
			...
			i ? i.apply(n.input ? n.input[0] : null, [a, n]) : n.input && n.input.trigger("change"),
		...
		parseDate : function (a, i, s) {
			...
			for (n = 0; a.length > n; n++)
				if (y)
					...
					case "@":
						...
						break;
					case "!":
						c = new Date((M("!") - this._ticksTo1970) / 1e4),
						f = c.getFullYear(),
						m = c.getMonth() + 1,
						D = c.getDate();
						break;
			...
			if (i.length > d && (o = i.substr(d), !/^\s+/.test(o)))
				throw "Extra/unparsed characters found in date: " + o;
			if (-1 === f ? f = (new Date).getFullYear() : 100 > f && (f += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (u >= f ? 0 : -100)), k > -1)
				for (m = 1, D = k; ; ) {
					if (r = this._getDaysInMonth(f, m - 1), r >= D)
						break;
					m++,
					D -= r
				}
			if (c = this._daylightSavingAdjust(new Date(f, m - 1, D)), c.getFullYear() !== f || c.getMonth() + 1 !== m || c.getDate() !== D)
				throw "Invalid date";
			return c
		},
		ATOM : "yy-mm-dd",
		...
		_generateHTML : function (e) {
			...
			et = e.drawYear;
			if (0 > Z && (Z += 12, et--), X)
				for (t = this._daylightSavingAdjust(new Date(X.getFullYear(), X.getMonth() - J[0] * J[1] + 1, X.getDate())), t = $ && $ > t ? $ : t; this._daylightSavingAdjust(new Date(et, Z, 1)) > t; )
					Z--, 0 > Z && (Z = 11, et--);
			for (e.drawMonth = Z, e.drawYear = et, a = this._get(e, "prevText"), a = B ? this.formatDate(a, this._daylightSavingAdjust(new Date(et, Z - V, 1)), this._getFormatConfig(e)) : a, i = this._canAdjustMonth(e, -1, et, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + a + "'><span class='ui-icon ui-icon-circle-triangle-" + (H ? "e" : "w") + "'>" + a + "</span></a>" : z ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + a + "'><span class='ui-icon ui-icon-circle-triangle-" + (H ? "e" : "w") + "'>" + a + "</span></a>", s = this._get(e, "nextText"), s = B ? this.formatDate(s, this._daylightSavingAdjust(new Date(et, Z + V, 1)), this._getFormatConfig(e)) : s, n = this._canAdjustMonth(e, 1, et, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (H ? "w" : "e") + "'>" + s + "</span></a>" : z ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (H ? "w" : "e") + "'>" + s + "</span></a>", r = this._get(e, "currentText"), o = this._get(e, "gotoCurrent") && e.currentDay ? Q : W, r = B ? this.formatDate(r, o, this._getFormatConfig(e)) : r, c = e.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(e, "closeText") + "</button>", d = U ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (H ? c : "") + (this._isInRange(e, o) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + r + "</button>" : "") + (H ? "" : c) + "</div>" : "", l = parseInt(this._get(e, "firstDay"), 10), l = isNaN(l) ? 0 : l, u = this._get(e, "showWeek"), h = this._get(e, "dayNames"), p = this._get(e, "dayNamesMin"), g = this._get(e, "monthNames"), _ = this._get(e, "monthNamesShort"), f = this._get(e, "beforeShowDay"), m = this._get(e, "showOtherMonths"), D = this._get(e, "selectOtherMonths"), k = this._getDefaultDate(e), y = "", M = 0; J[0] > M; M++) {
				for (b = "", this.maxRows = 4, w = 0; J[1] > w; w++) {
					...
					for (x += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + I + "'>" + (/all|left/.test(I) && 0 === M ? H ? n : i : "") + (/all|right/.test(I) && 0 === M ? H ? i : n : "") + this._generateMonthYearHeader(e, Z, et, $, X, M > 0 || w > 0, g, _) + "</div><table class='ui-datepicker-calendar'><thead>" + "<tr>", N = u ? "<th class='ui-datepicker-week-col'>" + this._get(e, "weekHeader") + "</th>" : "", v = 0; 7 > v; v++)
						Y = (v + l) % 7, N += "<th" + ((v + l + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + ">" + "<span title='" + h[Y] + "'>" + p[Y] + "</span></th>";
					for (x += N + "</tr></thead><tbody>", S = this._getDaysInMonth(et, Z), et === e.selectedYear && Z === e.selectedMonth && (e.selectedDay = Math.min(e.selectedDay, S)), A = (this._getFirstDayOfMonth(et, Z) - l + 7) % 7, T = Math.ceil((A + S) / 7), F = G ? this.maxRows > T ? this.maxRows : T : T, this.maxRows = F, j = this._daylightSavingAdjust(new Date(et, Z, 1 - A)), K = 0; F > K; K++) {
						for (x += "<tr>", O = u ? "<td class='ui-datepicker-week-col'>" + this._get(e, "calculateWeek")(j) + "</td>" : "", v = 0; 7 > v; v++)
							E = f ? f.apply(e.input ? e.input[0] : null, [j]) : [!0, ""], P = j.getMonth() !== Z, L = P && !D || !E[0] || $ && $ > j || X && j > X, O += "<td class='" + ((v + l + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (P ? " ui-datepicker-other-month" : "") + (j.getTime() === C.getTime() && Z === e.selectedMonth && e._keyEvent || k.getTime() === j.getTime() && k.getTime() === C.getTime() ? " " + this._dayOverClass : "") + (L ? " " + this._unselectableClass + " ui-state-disabled" : "") + (P && !m ? "" : " " + E[1] + (j.getTime() === Q.getTime() ? " " + this._currentClass : "") + (j.getTime() === W.getTime() ? " ui-datepicker-today" : "")) + "'" + (P && !m || !E[2] ? "" : " title='" + E[2].replace(/'/g, "&#39;") + "'") + (L ? "" : " data-handler='selectDay' data-event='click' data-month='" + j.getMonth() + "' data-year='" + j.getFullYear() + "'") + ">" + (P && !m ? "&#xa0;" : L ? "<span class='ui-state-default'>" + j.getDate() + "</span>" : "<a class='ui-state-default" + (j.getTime() === W.getTime() ? " ui-state-highlight" : "") + (j.getTime() === Q.getTime() ? " ui-state-active" : "") + (P ? " ui-priority-secondary" : "") + "' href='#'>" + j.getDate() + "</a>") + "</td>", j.setDate(j.getDate() + 1), j = this._daylightSavingAdjust(j);
						x += O + "</tr>"
					}
					Z++,
					Z > 11 && (Z = 0, et++),
					x += "</tbody></table>" + (G ? "</div>" + (J[0] > 0 && w === J[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""),
					b += x
				}
				y += b
			}
		...
		_generateMonthYearHeader : function (e, t, a, i, s, n, r, o) {
			...
			if (n || !f)
				...
				for (c = i && i.getFullYear() === a, d = s && s.getFullYear() === a, y += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>", l = 0; 12 > l; l++)
					(!c || l >= i.getMonth()) && (!d || s.getMonth() >= l) && (y += "<option value='" + l + "'" + (l === t ? " selected='selected'" : "") + ">" + o[l] + "</option>");
				y += "</select>"
			}
			if (D || (k += y + (!n && f && m ? "" : "&#xa0;")), !e.yearshtml)
				if (e.yearshtml = "", n || !m)
					k += "<span class='ui-datepicker-year'>" + a + "</span>";
				else {
					for (u = this._get(e, "yearRange").split(":"), h = (new Date).getFullYear(), p = function (e) {
						...
						return isNaN(t) ? h : t
					}, g = p(u[0]), _ = Math.max(g, p(u[1] || "")), g = i ? Math.max(g, i.getFullYear()) : g, _ = s ? Math.min(_, s.getFullYear()) : _, e.yearshtml += "<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>"; _ >= g; g++)
		...
		_isInRange : function (e, t) {
			...
			return c && (a = c.split(":"), i = (new Date).getFullYear(), r = parseInt(a[0], 10), o = parseInt(a[1], 10), a[0].match(/[+\-].*/) && (r += i), a[1].match(/[+\-].*/) && (o += i)),
...
(function (e) {
	...
	e.widget("ui.dialog", {
		...
		_moveToTop : function (e, t) {
			...
			return a && !t && this._trigger("focus", e),
			a
		},
		open : function () {
			var t = this;
		...
		_createButtons : function () {
			...
			e.isEmptyObject(a) || e.isArray(a) && !a.length ? (this.uiDialog.removeClass("ui-dialog-buttons"), undefined) : (e.each(a, function (a, r) {
					var i,
					n;
					r = e.isFunction(r) ? {
						click : r,
					...
					delete r.icons,
					delete r.showText,
					e("<button></button>", r).button(n).appendTo(t.uiButtonSet)
		...
		_makeDraggable : function () {
			...
			this.uiDialog.draggable({
				...
				start : function (r, i) {
					...
					a._blockFrames(),
					a._trigger("dragStart", r, t(i))
				},
				drag : function (e, r) {
					a._trigger("drag", e, t(r))
				},
				stop : function (i, n) {
					r.position = [n.position.left - a.document.scrollLeft(), n.position.top - a.document.scrollTop()],
					e(this).removeClass("ui-dialog-dragging"),
					a._unblockFrames(),
					a._trigger("dragStop", i, t(n))
				}
			})
		},
		_makeResizable : function () {
			...
			this.uiDialog.resizable({
				...
				start : function (r, i) {
					...
					a._blockFrames(),
					a._trigger("resizeStart", r, t(i))
				},
				resize : function (e, r) {
					a._trigger("resize", e, t(r))
				},
				stop : function (i, n) {
		...
		_size : function () {
			...
			a = "number" == typeof r.maxHeight ? Math.max(0, r.maxHeight - e) : "none",
			...
			if (this.options.modal) {
				...
				e.ui.dialog.overlayInstances || this._delay(function () {
					e.ui.dialog.overlayInstances && this.document.bind("focusin.dialog", function (r) {
						t._allowInteraction(r) || (r.preventDefault(), e(".ui-dialog:visible:last .ui-dialog-content").data(a)._focusTabbable())
					})
				}),
	...
	e.uiBackCompat !== !1 && e.widget("ui.dialog", e.ui.dialog, {
		_position : function () {
			...
			r = [],
			i = [0, 0];
			a ? (("string" == typeof a || "object" == typeof a && "0" in a) && (r = a.split ? a.split(" ") : [a[0], a[1]], 1 === r.length && (r[1] = r[0]), e.each(["left", "top"], function (e, t) {
						+r[e] === r[e] && (i[e] = r[e], r[e] = t)
					}), a = {
						my : r[0] + (0 > i[0] ? i[0] : "+" + i[0]) + " " + r[1] + (0 > i[1] ? i[1] : "+" + i[1]),
						at : r.join(" ")
					}), a = e.extend({}, e.ui.dialog.prototype.options.position, a)) : a = e.ui.dialog.prototype.options.position,
	...
	e.widget("ui.menu", {
		...
		_create : function () {
			...
			this._on({
				...
				"click .ui-menu-item:has(a)" : function (t) {
					...
					!this.mouseHandled && a.not(".ui-state-disabled").length && (this.mouseHandled = !0, this.select(t), a.has(".ui-menu").length ? this.expand(t) : this.element.is(":focus") || (this.element.trigger("focus", [!0]), this.active && 1 === this.active.parents(".ui-menu").length && clearTimeout(this.timer)))
				},
		...
		_keydown : function (t) {
			...
			default:
				...
				i.length || (s = String.fromCharCode(t.keyCode), o = RegExp("^" + a(s), "i"), i = this.activeMenu.children(".ui-menu-item").filter(function () {
							return o.test(e(this).children("a").text())
						})),
		...
		refresh : function () {
			...
			i.filter(":not(.ui-menu)").addClass("ui-menu ui-widget ui-widget-content ui-corner-all").hide().attr({
				...
				var t = e(this),
				i = t.prev("a"),
				r = e("<span>").addClass("ui-menu-icon ui-icon " + a).data("ui-menu-submenu-carat", !0);
		...
		focus : function (e, t) {
			...
			a = t.children(".ui-menu"),
			a.length && /^mouse/.test(e.type) && this._startOpening(a),
		...
		_scrollIntoView : function (t) {
			...
			n,
			o;
			this._hasScroll() && (a = parseFloat(e.css(this.activeMenu[0], "borderTopWidth")) || 0, i = parseFloat(e.css(this.activeMenu[0], "paddingTop")) || 0, r = t.offset().top - this.activeMenu.offset().top - a - i, s = this.activeMenu.scrollTop(), n = this.activeMenu.height(), o = t.height(), 0 > r ? this.activeMenu.scrollTop(s + r) : r + o > n && this.activeMenu.scrollTop(s + r - n + o))
		},
		blur : function (e, t) {
		...
		_open : function (t) {
			...
			t.show().removeAttr("aria-hidden").attr("aria-expanded", "true").position(a)
		},
		...
		nextPage : function (t) {
			...
			i,
			r;
			return this.active ? (this.isLastItem() || (this._hasScroll() ? (i = this.active.offset().top, r = this.element.height(), this.active.nextAll(".ui-menu-item").each(function () {
							return a = e(this),
							0 > a.offset().top - i - r
						}), this.focus(t, a)) : this.focus(t, this.activeMenu.children(".ui-menu-item")[this.active ? "last" : "first"]())), undefined) : (this.next(t), undefined)
		},
		previousPage : function (t) {
			var a,
			i,
			r;
			return this.active ? (this.isFirstItem() || (this._hasScroll() ? (i = this.active.offset().top, r = this.element.height(), this.active.prevAll(".ui-menu-item").each(function () {
							return a = e(this),
							a.offset().top - i + r > 0
						}), this.focus(t, a)) : this.focus(t, this.activeMenu.children(".ui-menu-item").first())), undefined) : (this.next(t), undefined)
		},
		_hasScroll : function () {
...
(function (e, t) {
	e.widget("ui.progressbar", {
		...
		_refreshValue : function () {
			...
			a = this._percentage();
			this.valueDiv.toggle(this.indeterminate || t > this.min).toggleClass("ui-corner-right", t === this.options.max).width(a.toFixed(0) + "%"),
...
(function (e) {
	...
	e.widget("ui.slider", e.ui.mouse, {
		...
		_createHandles : function () {
			...
			n = [];
			for (i = a.values && a.values.length || 1, s.length > i && (s.slice(i).remove(), s = s.slice(0, i)), t = s.length; i > t; t++)
				n.push(r);
		...
		_mouseCapture : function (t) {
			...
			return d.disabled ? !1 : (this.elementSize = {
					...
					(s > i || s === i && (t === u._lastChangedValue || u.values(t) === d.min)) && (s = i, r = e(this), n = t)
				}), o = this._start(t, n), o === !1 ? !1 : (this._mouseSliding = !0, this._handleIndex = n, r.addClass("ui-state-active").focus(), l = r.offset(), h = !e(t.target).parents().addBack().is(".ui-slider-handle"), this._clickOffset = h ? {
						left : 0,
						top : 0
					}
					 : {
				...
				}, this.handles.hasClass("ui-state-hover") || this._slide(t, n, a), this._animateOff = !0, !0))
		},
		_mouseStart : function () {
			return !0
		},
		...
		_slide : function (e, t, i) {
			...
			s,
			r;
			this.options.values && this.options.values.length ? (a = this.values(t ? 0 : 1), 2 === this.options.values.length && this.options.range === !0 && (0 === t && i > a || 1 === t && a > i) && (i = a), i !== this.values(t) && (s = this.values(), s[t] = i, r = this._trigger("slide", e, {
							handle : this.handles[t],
							value : i,
							values : s
						}), a = this.values(t ? 0 : 1), r !== !1 && this.values(t, i, !0))) : i !== this.value() && (r = this._trigger("slide", e, {
						handle : this.handles[t],
						value : i
					}), r !== !1 && this.value(i))
		},
		...
		values : function (t, i) {
			...
			for (a = this.options.values, s = arguments[0], r = 0; a.length > r; r += 1)
				a[r] = this._trimAlignValue(s[r]), this._change(null, r);
			this._refreshValue()
		},
		_setOption : function (t, i) {
			var a,
			...
			case "value":
				...
				break;
			case "values":
				for (this._animateOff = !0, this._refreshValue(), a = 0; s > a; a += 1)
					this._change(null, a);
				this._animateOff = !1;
				break;
			case "min":
		...
		_values : function (e) {
			...
			if (this.options.values && this.options.values.length) {
				for (i = this.options.values.slice(), a = 0; i.length > a; a += 1)
		...
		_trimAlignValue : function (e) {
			...
			a = e - i;
			return 2 * Math.abs(i) >= t && (a += i > 0 ? t : -t),
		...
		_refreshValue : function () {
			...
			this.options.values && this.options.values.length ? this.handles.each(function (a) {
				i = 100 * ((l.values(a) - l._valueMin()) / (l._valueMax() - l._valueMin())),
				u["horizontal" === l.orientation ? "left" : "bottom"] = i + "%",
				e(this).stop(1, 1)[h ? "animate" : "css"](u, o.animate),
				l.options.range === !0 && ("horizontal" === l.orientation ? (0 === a && l.range.stop(1, 1)[h ? "animate" : "css"]({
							left : i + "%"
				...
				t = i
			}) : (a = this.value(), s = this._valueMin(), r = this._valueMax(), i = r !== s ? 100 * ((a - s) / (r - s)) : 0, u["horizontal" === this.orientation ? "left" : "bottom"] = i + "%", this.handle.stop(1, 1)[h ? "animate" : "css"](u, o.animate), "min" === n && "horizontal" === this.orientation && this.range.stop(1, 1)[h ? "animate" : "css"]({
					width : i + "%"
				}, o.animate), "max" === n && "horizontal" === this.orientation && this.range[h ? "animate" : "css"]({
					width : 100 - i + "%"
				}, {
					queue : !1,
					duration : o.animate
				}), "min" === n && "vertical" === this.orientation && this.range.stop(1, 1)[h ? "animate" : "css"]({
					height : i + "%"
				}, o.animate), "max" === n && "vertical" === this.orientation && this.range[h ? "animate" : "css"]({
					height : 100 - i + "%"
				}, {
					queue : !1,
					duration : o.animate
		...
		_handleEvents : {
			keydown : function (i) {
				...
				case e.ui.keyCode.DOWN:
				case e.ui.keyCode.LEFT:
					if (i.preventDefault(), !this._keySliding && (this._keySliding = !0, e(i.target).addClass("ui-state-active"), a = this._start(i, o), a === !1))
						return
				}
				switch (n = this.options.step, s = r = this.options.values && this.options.values.length ? this.values(o) : this.value(), i.keyCode) {
				case e.ui.keyCode.HOME:
					r = this._valueMin();
					break;
				case e.ui.keyCode.END:
...
(function (e) {
	...
	e.widget("ui.spinner", {
		...
		_adjustValue : function (e) {
			...
			i,
			a = this.options;
			return t = null !== a.min ? a.min : 0,
			i = e - t,
			i = Math.round(i / a.step) * a.step,
			e = t + i,
			e = parseFloat(e.toFixed(this._precision())),
			null !== a.max && e > a.max ? a.max : null !== a.min && a.min > e ? a.min : e
		},
		_stop : function (e) {
...
(function (e, t) {
	...
	e.widget("ui.tabs", {
		...
		_initialActive : function () {
			...
			i !== !1 && (i = this.tabs.index(this.tabs.eq(i)), -1 === i && (i = a ? !1 : 0)),
			!a && i === !1 && this.anchors.length && (i = 0),
			i
		},
		_getCreateEventData : function () {
			return {
		...
		_tabKeydown : function (i) {
			...
			if (!this._handlePageNav(i)) {
				...
				i.ctrlKey || (a.attr("aria-selected", "false"), this.tabs.eq(s).attr("aria-selected", "true"), this.activating = this._delay(function () {
		...
		_findNextTab : function (t, i) {
			...
			for (var s = this.tabs.length - 1; -1 !== e.inArray(a(), this.options.disabled); )
				t = i ? t + 1 : t - 1;
			return t
		},
		...
		_processTabs : function () {
			...
			this.anchors.each(function (i, s) {
				...
				n,
				o,
				h = e(s).uniqueId().attr("id"),
				l = e(s).closest("li"),
				u = l.attr("aria-controls");
				a(s) ? (r = s.hash, n = t.element.find(t._sanitizeSelector(r))) : (o = t._tabId(l), r = "#" + o, n = t.element.find(r), n.length || (n = t._createPanel(o), n.insertAfter(t.panels[i - 1] || t.tablist)), n.attr("aria-live", "polite")),
		...
		_setupDisabled : function (t) {
			...
			for (var i, a = 0; i = this.tabs[a]; a++)
				t === !0 || -1 !== e.inArray(a, t) ? e(i).addClass("ui-state-disabled").attr("aria-disabled", "true") : e(i).removeClass("ui-state-disabled").removeAttr("aria-disabled");
		...
		_eventHandler : function (t) {
			...
			t.preventDefault(),
			r.hasClass("ui-state-disabled") || r.hasClass("ui-tabs-loading") || this.running || n && !i.collapsible || this._trigger("beforeActivate", t, u) === !1 || (i.active = o ? !1 : this.tabs.index(r), this.active = n ? e() : r, this.xhr && this.xhr.abort(), l.length || h.length || e.error("jQuery UI Tabs: Mismatching fragment identifier."), h.length && this.load(this.tabs.index(r), t), this._toggle(t, u))
		},
		_toggle : function (t, i) {
			...
			function s() {
				...
				n.length && r.options.show ? r._show(n, r.options.show, a) : (n.show(), a())
			}
			var r = this,
			n = i.newPanel,
			o = i.oldPanel;
		...
		disable : function (i) {
			...
			if (a !== !0) {
				if (i === t)
					...
					if (i = this._getIndex(i), -1 !== e.inArray(i, a))
						return;
...
(function (e) {
	function t(t, i) {
		...
		a.push(i),
		t.data("ui-tooltip-id", i).attr("aria-describedby", e.trim(a.join(" ")))
	}
	function i(t) {
		...
		a = e.trim(a.join(" ")),
		a ? t.attr("aria-describedby", a) : t.removeAttr("aria-describedby")
	}
	var a = 0;
	e.widget("ui.tooltip", {
		version : "1.10.3",
		...
		open : function (t) {
			...
			a.length && !a.data("ui-tooltip-id") && (a.attr("title") && a.data("ui-tooltip-title", a.attr("title")), a.data("ui-tooltip-open", !0), t && "mouseover" === t.type && a.parents().each(function () {
					var t,
					a = e(this);
					a.data("ui-tooltip-open") && (t = e.Event("blur"), t.target = t.currentTarget = this, i.close(t, !0)),
					a.attr("title") && (a.uniqueId(), i.parents[this.id] = {
							element : this,
							title : a.attr("title")
						}, a.attr("title", ""))
		...
		_destroy : function () {
			...
			e.each(this.tooltips, function (i, a) {
				...
				t.close(s, !0),
				e("#" + i).remove(),
				a.data("ui-tooltip-title") && (a.attr("title", a.data("ui-tooltip-title")), a.removeData("ui-tooltip-title"))
			})
		}
	})
})(jQuery);
(function (e, t) {
	...
	function (e, t) {
		...
		function r(e, t, a) {
			return a = (a + 1) % 1,
			1 > 6 * a ? e + 6 * (t - e) * a : 1 > 2 * a ? t : 2 > 3 * a ? e + 6 * (t - e) * (2 / 3 - a) : e
		}
		var n,
		...
		c.rgba = m.style.backgroundColor.indexOf("rgba") > -1,
		p(l, function (e, t) {
			t.cache = "_" + e,
			t.props.alpha = {
				idx : 3,
		...
		u.fn = e.extend(u.prototype, {
				parse : function (r, s, o, d) {
					...
					c = e.type(r),
					m = this._rgba = [];
					return s !== t && (r = [r, s, o, d], c = "array"),
					"string" === c ? this.parse(i(r) || n._default) : "array" === c ? (p(l.rgba.props, function (e, t) {
							m[t.idx] = a(r[t.idx], t)
				...
				toHslaString : function () {
					...
					return 1 === a[3] && (a.pop(), t = "hsl("),
					t + a.join() + ")"
				},
				toHexString : function (t) {
					var a = this._rgba.slice(),
					i = a.pop();
					return t && a.push(~~(255 * i)),
					"#" + e.map(a, function (e) {
		...
		l.hsla.to = function (e) {
			...
			l = o + d,
			h = .5 * l;
			return t = d === o ? 0 : i === o ? 60 * (r - n) / u + 360 : r === o ? 60 * (n - i) / u + 120 : 60 * (i - r) / u + 240,
			a = 0 === u ? 0 : .5 >= h ? u / l : u / (2 - l),
			[Math.round(t) % 360, a, h, null == s ? 1 : s]
		},
		...
		p(l, function (i, r) {
			...
			l = r.from;
			u.fn[i] = function (i) {
				if (d && !this[s] && (this[s] = d(this._rgba)), i === t)
					return this[s].slice();
				var r,
				o = e.type(i),
		...
		u.hook = function (t) {
			...
			p(a, function (t, a) {
					...
					set : function (t, r) {
						...
						if ("transparent" !== r && ("string" !== e.type(r) || (n = i(r)))) {
							if (r = u(n || r), !c.rgba && 1 !== r._rgba[3]) {
								for (s = "backgroundColor" === a ? t.parentNode : t; ("" === o || "transparent" === o) && s && s.style; )
									try {
				...
				e.fx.step[a] = function (t) {
					t.colorInit || (t.start = u(t.elem, a), t.end = u(t.end), t.colorInit = !0),
					e.cssHooks[a].set(t.elem, t.start.transition(t.end, t.pos))
				}
			})
		},
		u.hook(s),
	...
	function () {
		function a(t) {
			...
			if (r && r.length && r[0] && r[r[0]])
				for (i = r.length; i--; )
					a = r[i], "string" == typeof r[a] && (n[e.camelCase(a)] = r[a]);
			else
				for (a in r)
					"string" == typeof r[a] && (n[a] = r[a]);
			return n
		}
		function i(t, a) {
			var i,
			...
			s = {};
			for (i in a)
				r = a[i], t[i] !== r && (n[i] || (e.fx.step[i] || !isNaN(parseFloat(r))) && (s[i] = r));
			return s
		}
	...
	function () {
		function i(t, a, i, r) {
			return e.isPlainObject(t) && (a = t, t = t.effect),
			t = {
				effect : t
			},
			null == a && (a = {}),
			e.isFunction(a) && (r = a, i = null, a = {}),
			("number" == typeof a || e.fx.speeds[a]) && (r = i, i = a, a = {}),
			e.isFunction(i) && (r = i, i = null),
			a && e.extend(t, a),
			i = i || a.duration,
			t.duration = e.fx.off ? 0 : "number" == typeof i ? i : i in e.fx.speeds ? e.fx.speeds[i] : e.fx.speeds._default,
			t.complete = r || a.complete,
			t
		}
		function r(t) {
		...
		e.extend(e.effects, {
			...
			restore : function (e, i) {
				...
				for (n = 0; i.length > n; n++)
					null !== i[n] && (r = e.data(a + i[n]), r === t && (r = ""), e.css(i[n], r))
			},
			...
			removeWrapper : function (t) {
				...
				return t.parent().is(".ui-effects-wrapper") && (t.parent().replaceWith(t), (t[0] === a || e.contains(t[0], a)) && e(a).focus()),
				t
			},
	...
	function () {
		...
		e.extend(t, {
			...
			Bounce : function (e) {
				for (var t, a = 4; ((t = Math.pow(2, --a)) - 1) / 11 > e; );
...
(function (e) {
	...
	e.effects.effect.blind = function (i, r) {
		...
		g = {},
		y = "show" === l;
		d.parent().is(".ui-effects-wrapper") ? e.effects.save(d.parent(), u) : e.effects.save(d, u),
		d.show(),
		s = e.effects.createWrapper(d).css({
				overflow : "hidden"
			}),
		n = s[m](),
		o = parseFloat(s.css(p)) || 0,
		g[m] = y ? n : 0,
		f || (d.css(c ? "bottom" : "right", 0).css(c ? "top" : "left", "auto").css({
				position : "absolute"
			}), g[p] = y ? o : n + o),
		y && (s.css(m, 0), f || s.css(p, o + n)),
		s.animate(g, {
			duration : i.duration,
			easing : i.easing,
			queue : !1,
...
(function (e) {
	e.effects.effect.bounce = function (t, a) {
		var i,
		r,
		s,
		n = e(this),
		o = ["position", "top", "bottom", "left", "right", "height", "width"],
		d = e.effects.setMode(n, t.mode || "effect"),
		u = "hide" === d,
		l = "show" === d,
		h = t.direction || "up",
		c = t.distance,
		...
		x = n.queue(),
		v = x.length;
		for ((l || u) && o.push("opacity"), e.effects.save(n, o), n.show(), e.effects.createWrapper(n), c || (c = n["top" === y ? "outerHeight" : "outerWidth"]() / 3), l && (s = {
					opacity : 1
				}, s[y] = 0, n.css("opacity", 0).css(y, k ? 2 * -c : 2 * c).animate(s, f, g)), u && (c /= Math.pow(2, m - 1)), s = {}, s[y] = 0, i = 0; m > i; i++)
			r = {},
		r[y] = (k ? "-=" : "+=") + c,
		n.animate(r, f, g).animate(s, f, g),
		c = u ? 2 * c : c / 2;
		u && (r = {
				opacity : 0
			}, r[y] = (k ? "-=" : "+=") + c, n.animate(r, f, g)),
		n.queue(function () {
			u && n.hide(),
		...
		v > 1 && x.splice.apply(x, [1, 0].concat(x.splice(v, p + 1))),
		n.dequeue()
	}
})(jQuery);
(function (e) {
	e.effects.effect.clip = function (t, a) {
		var i,
		r,
		s,
		n = e(this),
		o = ["position", "top", "bottom", "left", "right", "height", "width"],
		d = e.effects.setMode(n, t.mode || "hide"),
		u = "show" === d,
		...
		e.effects.save(n, o),
		n.show(),
		i = e.effects.createWrapper(n).css({
				overflow : "hidden"
			}),
		r = "IMG" === n[0].tagName ? i : n,
		s = r[c](),
		u && (r.css(c, 0), r.css(m, s / 2)),
		p[c] = u ? s : 0,
		p[m] = u ? 0 : s / 2,
		r.animate(p, {
			queue : !1,
...
(function (e) {
	e.effects.effect.drop = function (t, a) {
		var i,
		r = e(this),
		...
		i = t.distance || r["top" === u ? "outerHeight" : "outerWidth"](!0) / 2,
		o && r.css("opacity", 0).css(u, "pos" === l ? -i : i),
		h[u] = (o ? "pos" === l ? "+=" : "-=" : "pos" === l ? "-=" : "+=") + i,
		r.animate(h, {
			queue : !1,
			duration : t.duration,
...
(function (e) {
	e.effects.effect.explode = function (t, a) {
		function i() {
			x.push(this),
			x.length === h * c && r()
		}
		...
		c = h,
		m = e(this),
		p = e.effects.setMode(m, t.mode || "hide"),
		f = "show" === p,
		g = m.show().css("visibility", "hidden").offset(),
		y = Math.ceil(m.outerWidth() / c),
		k = Math.ceil(m.outerHeight() / h),
		x = [];
		for (s = 0; h > s; s++)
			for (d = g.top + s * k, l = s - (h - 1) / 2, n = 0; c > n; n++)
				o = g.left + n * y, u = n - (c - 1) / 2, m.clone().appendTo("body").wrap("<div></div>").css({
					position : "absolute",
					visibility : "visible",
					left : -n * y,
					top : -s * k
...
(function (e) {
	e.effects.effect.fold = function (t, a) {
		var i,
		r,
		s = e(this),
		...
		r = m ? [i.width(), i.height()] : [i.height(), i.width()],
		h && (l = parseInt(h[1], 10) / 100 * r[u ? 0 : 1]),
		d && i.css(c ? {
			height : 0,
			width : l
		}
		...
		g[p[0]] = d ? r[0] : l,
		y[p[1]] = d ? r[1] : 0,
		i.animate(g, f, t.easing).animate(y, f, t.easing, function () {
			u && s.hide(),
...
(function (e) {
	e.effects.effect.highlight = function (t, a) {
		var i = e(this),
...
(function (e) {
	e.effects.effect.pulsate = function (t, a) {
		var i,
		r = e(this),
		...
		c = r.queue(),
		m = c.length;
		for ((n || !r.is(":visible")) && (r.css("opacity", 0).show(), h = 1), i = 1; u > i; i++)
			r.animate({
				opacity : h
			}, l, t.easing), h = 1 - h;
		r.animate({
		...
		m > 1 && c.splice.apply(c, [1, 0].concat(c.splice(m, u + 1))),
		r.dequeue()
	}
})(jQuery);
(function (e) {
	e.effects.effect.puff = function (t, a) {
		var i = e(this),
		r = e.effects.setMode(i, t.mode || "hide"),
		s = "hide" === r,
		n = parseInt(t.percent, 10) || 150,
		o = n / 100,
		d = {
			height : i.height(),
			width : i.width(),
		...
		e.extend(t, {
			...
			from : s ? d : {
				...
				outerWidth : d.outerWidth * o
			}
		}),
		i.effect(t)
	},
	e.effects.effect.scale = function (t, a) {
		var i = e(this),
		r = e.extend(!0, {}, t),
		s = e.effects.setMode(i, t.mode || "effect"),
		n = parseInt(t.percent, 10) || (0 === parseInt(t.percent, 10) ? 0 : "hide" === s ? 0 : 100),
		o = t.direction || "both",
		d = t.origin,
		u = {
			height : i.height(),
		...
		l = {
			y : "horizontal" !== o ? n / 100 : 1,
			x : "vertical" !== o ? n / 100 : 1
		};
		r.effect = "size",
		r.queue = !1,
		r.complete = a,
		"effect" !== s && (r.origin = d || ["middle", "center"], r.restore = !0),
		r.from = t.from || ("show" === s ? {
				height : 0,
				width : 0,
				outerHeight : 0,
				outerWidth : 0
		...
		r.fade && ("show" === s && (r.from.opacity = 0, r.to.opacity = 1), "hide" === s && (r.from.opacity = 1, r.to.opacity = 0)),
		i.effect(r)
	},
	e.effects.effect.size = function (t, a) {
		var i,
		r,
		s,
		n = e(this),
		o = ["position", "top", "bottom", "left", "right", "width", "height", "overflow", "opacity"],
		d = ["position", "top", "bottom", "left", "right", "overflow", "opacity"],
		u = ["width", "height", "overflow"],
		l = ["fontSize"],
		h = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"],
		c = ["borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight"],
		m = e.effects.setMode(n, t.mode || "effect"),
		p = t.restore || "effect" !== m,
		f = t.scale || "both",
		...
		"toggle" === t.mode && "show" === m ? (n.from = t.to || k, n.to = t.from || i) : (n.from = t.from || ("show" === m ? k : i), n.to = t.to || ("hide" === m ? k : i)),
		s = {
			from : {
				y : n.from.height / i.height,
				x : n.from.width / i.width
			},
			to : {
				y : n.to.height / i.height,
				x : n.to.width / i.width
			}
		},
		("box" === f || "both" === f) && (s.from.y !== s.to.y && (x = x.concat(h), n.from = e.effects.setTransition(n, h, s.from.y, n.from), n.to = e.effects.setTransition(n, h, s.to.y, n.to)), s.from.x !== s.to.x && (x = x.concat(c), n.from = e.effects.setTransition(n, c, s.from.x, n.from), n.to = e.effects.setTransition(n, c, s.to.x, n.to))),
		("content" === f || "both" === f) && s.from.y !== s.to.y && (x = x.concat(l).concat(u), n.from = e.effects.setTransition(n, l, s.from.y, n.from), n.to = e.effects.setTransition(n, l, s.to.y, n.to)),
		e.effects.save(n, x),
		n.show(),
		e.effects.createWrapper(n),
		n.css("overflow", "hidden").css(n.from),
		g && (r = e.effects.getBaseline(g, i), n.from.top = (i.outerHeight - n.outerHeight()) * r.y, n.from.left = (i.outerWidth - n.outerWidth()) * r.x, n.to.top = (i.outerHeight - n.to.outerHeight) * r.y, n.to.left = (i.outerWidth - n.to.outerWidth) * r.x),
		n.css(n.from),
		("content" === f || "both" === f) && (h = h.concat(["marginTop", "marginBottom"]).concat(l), c = c.concat(["marginLeft", "marginRight"]), u = o.concat(h).concat(c), n.find("*[width]").each(function () {
				var a = e(this),
				i = {
					height : a.height(),
					width : a.width(),
				...
				s.from.y !== s.to.y && (a.from = e.effects.setTransition(a, h, s.from.y, a.from), a.to = e.effects.setTransition(a, h, s.to.y, a.to)),
				s.from.x !== s.to.x && (a.from = e.effects.setTransition(a, c, s.from.x, a.from), a.to = e.effects.setTransition(a, c, s.to.x, a.to)),
				a.css(a.from),
				a.animate(a.to, t.duration, t.easing, function () {
					p && e.effects.restore(a, u)
				})
			})),
		n.animate(n.to, {
			queue : !1,
			...
			easing : t.easing,
			complete : function () {
				0 === n.to.opacity && n.css("opacity", n.from.opacity),
				"hide" === m && n.hide(),
				e.effects.restore(n, x),
				p || ("static" === y ? n.css({
						position : "relative",
						top : n.to.top,
						left : n.to.left
					}) : e.each(["top", "left"], function (e, t) {
						n.css(t, function (t, a) {
							var i = parseInt(a, 10),
							r = e ? n.to.left : n.to.top;
							return "auto" === a ? r + "px" : i + r + "px"
						})
					})),
				e.effects.removeWrapper(n),
				a()
...
(function (e) {
	e.effects.effect.shake = function (t, a) {
		var i,
		r = e(this),
		s = ["position", "top", "bottom", "left", "right", "height", "width"],
		n = e.effects.setMode(r, t.mode || "effect"),
		o = t.direction || "left",
		d = t.distance || 20,
		u = t.times || 3,
		l = 2 * u + 1,
		...
		y = r.queue(),
		x = y.length;
		for (e.effects.save(r, s), r.show(), e.effects.createWrapper(r), p[c] = (m ? "-=" : "+=") + d, f[c] = (m ? "+=" : "-=") + 2 * d, g[c] = (m ? "-=" : "+=") + 2 * d, r.animate(p, h, t.easing), i = 1; u > i; i++)
			r.animate(f, h, t.easing).animate(g, h, t.easing);
		r.animate(f, h, t.easing).animate(p, h / 2, t.easing).queue(function () {
			"hide" === n && r.hide(),
			e.effects.restore(r, s),
			e.effects.removeWrapper(r),
			a()
		}),
		x > 1 && y.splice.apply(y, [1, 0].concat(y.splice(x, l + 1))),
		r.dequeue()
	}
})(jQuery);
(function (e) {
	e.effects.effect.slide = function (t, a) {
		...
		n = e.effects.setMode(r, t.mode || "show"),
		o = "show" === n,
		d = t.direction || "left",
		u = "up" === d || "down" === d ? "top" : "left",
		l = "up" === d || "left" === d,
		...
		e.effects.save(r, s),
		r.show(),
		i = t.distance || r["top" === u ? "outerHeight" : "outerWidth"](!0),
		e.effects.createWrapper(r).css({
			overflow : "hidden"
		}),
		o && r.css(u, l ? isNaN(i) ? "-" + i : -i : i),
		h[u] = (o ? l ? "+=" : "-=" : l ? "-=" : "+=") + i,
		r.animate(h, {
			queue : !1,
			duration : t.duration,
...
(function (e) {
	e.effects.effect.transfer = function (t, a) {
		var i = e(this),
		r = e(t.to),
