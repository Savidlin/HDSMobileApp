...
class ObjectUtil {
     ...
     */
    static values(obj: any, keys?: string[]): any[] {
        "use strict";
     ...
     */
    static valuesNotNull(obj: any, keys?: string[]): any[] {
        "use strict";
        if (keys != null && !Array.isArray(keys)) {
            throw new Error("incorrect usage (" + obj + ", " + keys + "), expected (Object obj, Array<String> [keys])");
        }
     ...
     */
    static hasAnyNonFalseyProperties(obj: any, propNames: string[]) {
     ...
     * @see #hasMatchingProperties()
     */
    static hasAnyNonNullProperties(obj: any, propNames: string[]) {
     ...
     * @see #hasMatchingProperties()
     */
    static hasNonNullProperties(obj: any, propNames: string[]) {
     ...
     */
    static hasMatchingProperties(obj: any, propNames: string[], template_condition: (propVal) => boolean, requiredCount: number = (propNames != null ? propNames.length : 0)): boolean {
        "use strict";
        if (obj == null) {
            return false;
        }
     ...
     */
    static getProp(obj: any, propertyName: string): any {
        "use strict";
     ...
     */
    static getProps(obj: any, propertyNames: string[]): any[] {
        "use strict";
     ...
     */
    static orEmptyString<T>(val: T): any {
        "use strict";
        return val != null ? val : "";
    }
     ...
     */
    static extend(classChild: any, classParent: any, allowChildToOverride: boolean = true): void {
        "use strict";
     ...
     * @see #extend()
     */
    static extendToStatic(classChild: any, classParent: any, allowChildToOverride: boolean = true, throwErrorIfOverwrites: boolean = true): void {
        "use strict";
     ...
     */
    static getPrototypeTree(obj: any): any[] {
        var res = [];
        var proto = obj;
        do {
            res.push(proto);
     ...
     */
    static getParentConstructorByName(obj: any, name: string): any {
        if (obj == null) {
     ...
     */
    static runTest(testFunctions: { (any): void }[]): void {
        if (!Array.isArray(testFunctions)) {
            ...
            testFunctions = [(<{ (any): void }><any>testFunctions)];
        }
...
/* end of ObjectUtil class definition */
