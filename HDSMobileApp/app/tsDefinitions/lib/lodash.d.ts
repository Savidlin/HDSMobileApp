// retrieved https://github.com/borisyankov/DefinitelyTyped/tree/master/lodash at 2015-2-2
...
declare module _ {
    ...
    **/
    ...
    interface LoDashArrayWrapper<T> extends LoDashWrapperBase<T[], LoDashArrayWrapper<T>> {
        ...
        // custom (2015-2-18 Benjamin)
        size(): LoDashWrapper<number>;
        // end-custom
    }
    ...
    **********/
    ...
    interface LoDashStatic {
        ...
        **/
        // custom (2015-2-18 Benjamin)
        values<T>(object: { [index: number]: T }): T[];
        values<T>(object: { [index: string]: T }): T[];
        // end-custom
    }
